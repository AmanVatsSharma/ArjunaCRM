<div align="center">
  ...
  <h1>Create ArjunaCRM App</h1>

<a href="https://www.npmjs.com/package/create-arjuna-app"><img alt="NPM version" src="https://img.shields.io/npm/v/create-arjuna-app.svg?style=for-the-badge&labelColor=000000"></a>
...
Create ArjunaCRM App is the official scaffolding CLI for building apps on top of [ArjunaCRM CRM](https://vedpragya.com). It sets up a ready‑to‑run project that works seamlessly with the [arjuna-sdk](https://www.npmjs.com/package/arjuna-sdk).
...
- A ArjunaCRM workspace and an API key (create one at https://app.vedpragya.com/settings/api-webhooks)
...
# Generate a typed ArjunaCRM client and workspace entity types
yarn generate
...
- A minimal app structure ready for ArjunaCRM
- TypeScript configuration
- Prewired scripts that wrap the `arjuna` CLI from arjuna-sdk
