...
const config: ApplicationConfig = {
  ...
  applicationVariables: {
    ARJUNA_API_KEY: {
      ...
      value: '',
      description:
        'API key for the ArjunaCRM CRM instance (used for authentication).',
    },
    AI_PROVIDER_API_KEY: {
    ...
    ARJUNA_API_URL: {
      ...
      isSecret: false,
      value: 'https://unpaid-interns.vedpragya.com',
      description:
        'The base URL for the ArjunaCRM CRM server (e.g., https://your-instance.vedpragya.com).',
    },
