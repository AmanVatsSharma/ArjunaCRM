...
const config: ApplicationConfig = {
  ...
  applicationVariables: {
    ARJUNA_API_KEY: {
      ...
      value: '',
      description:
        'Workspace API key used by the rollup engine to call the ArjunaCRM REST API.',
    },
    ARJUNA_API_BASE_URL: {
      ...
      value: '',
      description:
        'Optional override for the REST base URL (defaults to https://app.vedpragya.com/rest).',
    },
