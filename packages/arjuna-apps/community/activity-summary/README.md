# ArjunaCRM CRM Activity Reporter ��

A TypeScript-based reporting bot that summarizes activity from your ArjunaCRM CRM workspace and sends daily/periodic reports to Slack, Discord, and WhatsApp. Meet Kylian Mbaguette, your friendly CRM activity reporter!
...
- TypeScript
- A [ArjunaCRM CRM](https://vedpragya.com) account with API access
...
|----------|----------|-------------|
| `ARJUNA_API_KEY` | ✅ Yes | Your ArjunaCRM CRM API key |
...
1. **Data Collection**: The bot queries the ArjunaCRM CRM API for activities within the specified time range
2. **Analysis**:
...
This bot uses the [ArjunaCRM CRM REST API](https://api.vedpragya.com/rest/). The following endpoints are used:
...
- **Solution**: Verify your `ARJUNA_API_KEY` is correct and has necessary permissions
