...
/**
 * Fetch historical Fireflies meetings and insert into ArjunaCRM.
 *
 * Usage:
...
import { ArjunaCRMCrmService } from '../src/arjuna-crm-service';
import {
  getApiUrl,
  getFirefliesPlan,
...
const main = async (): Promise<void> => {
  ...
  if (!arjunaApiKey) {
    console.error('❌ ARJUNA_API_KEY is required');
    process.exit(1);
  }
