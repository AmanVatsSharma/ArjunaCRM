...
const config: ApplicationConfig = {
  ...
  description: 'Sync Fireflies meeting summaries, sentiment, and action items into ArjunaCRM.',
  icon: 'IconMicrophone',
  applicationVariables: {
    ...
    ARJUNA_API_KEY: {
      ...
      description: 'ArjunaCRM API key used when running scripts locally',
      //isSecret: true,
      value: '',
    },
    SERVER_URL: {
      universalIdentifier: '9b3a5e8e-5973-4e6b-a059-2966075652aa',
      description: 'Base URL for the ArjunaCRM workspace (default: http://localhost:3000)',
