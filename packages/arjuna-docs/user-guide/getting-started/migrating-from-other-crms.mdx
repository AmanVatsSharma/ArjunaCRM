...
info: Step-by-step guide for migrating data and processes from other CRM systems to ArjunaCRM.
image: /images/user-guide/what-is-arjuna/migrating_crm.png
sectionInfo: A brief guide to grasp the basics of ArjunaCRM
---
<Frame>
...
- **Use ArjunaCRM IDs** for complex relationships
...
If you're moving from ArjunaCRM self-hosted to ArjunaCRM Cloud:
