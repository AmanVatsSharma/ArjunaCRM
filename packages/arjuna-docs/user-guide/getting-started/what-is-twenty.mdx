---
title: What is ArjunaCRM
info: "Discover ArjunaCRM, an open-source CRM, its features, benefits, system requirements, and how to get involved."
...
ArjunaCRM is the leading open-source CRM, crafted by hundreds of contributors to suit your unique business needs.
...
At first, ArjunaCRM looks like most CRMs you already know: you can track deals, organize contacts, manage tasks and notes.
...
Open-source is the bedrock of our approach, ensuring that ArjunaCRM evolves with its community, for its community.
...
[Register here](https://app.vedpragya.com) or [become a contributor on GitHub](https://github.com/vedpragyabharat/arjuna).
