---
title: Integrations
info: "Connect ArjunaCRM to your existing tools and build custom automations."
...
1. Visit [ArjunaCRM on Zapier](https://zapier.com/apps/arjuna/integrations)
2. Create a new Zap with ArjunaCRM as trigger or action
3. Generate an API key in Settings → API & Webhooks
4. Connect your ArjunaCRM workspace to Zapier
...
The future of ArjunaCRM integrations is community-driven, AI-assisted, and infinitely extensible.
