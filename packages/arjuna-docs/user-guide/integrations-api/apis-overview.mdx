...
sectionInfo: Learn how to connect ArjunaCRM to your other tools.
---
<Frame>
  <img src="/images/user-guide/api/api-overview.png" alt="Header" />
</Frame>

ArjunaCRM was built to be developer-friendly, offering powerful APIs that adapt to your custom data model. We provide four distinct API types to meet different integration needs.

## Developer-First Approach

ArjunaCRM generates APIs specifically for your data model, meaning:
