---
title: Glossary
info: "Get familiar with essential terminology used in ArjunaCRM."
...
## API
API (Application Programming Interface) allows you to connect ArjunaCRM with other software systems and build custom integrations.
