...
Yes, you can use ArjunaCRM for free while self-hosting. You will get access to everything included in the (cloud) Pro subscription, except the support from our core-team. Support is accessible via our Discord community.
...
We do not offer free seats. Pricing is per user and each user needs a licence to access ArjunaCRM.
</Accordion>
