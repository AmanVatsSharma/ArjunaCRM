---
title: Se déplacer dans ArjunaCRM
...
Lorsque vous vous connectez à ArjunaCRM pour la première fois, la mise en page devrait être intuitive. Elle est conçue pour vous aider à naviguer rapidement et rester organisé, sans vous gêner.
...
Le menu commande vous donne **un accès rapide aux actions et à la recherche** dans ArjunaCRM. Vous pouvez y accéder de deux manières :
...
- Accéder aux enregistrements supprimés (ArjunaCRM prend en charge les suppressions douces et rigides)
