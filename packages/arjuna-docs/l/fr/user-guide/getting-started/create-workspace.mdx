...
info: "Suivez un guide pas-à-pas sur comment s'inscrire sur ArjunaCRM, choisir un plan d'abonnement, confirmer votre paiement et configurer votre compte, avec des conseils supplémentaires pour obtenir de l'aide si nécessaire."
...
1. Allez sur [Inscription à ArjunaCRM](https://app.vedpragya.com).
...
Pour toute question ou aide, contactez l'équipe de support dédiée à [contact@vedpragya.com](mailto:contact@vedpragya.com) ou envoyez un message sur [Discord](https://discord.gg/cx5n4Jzs57)
