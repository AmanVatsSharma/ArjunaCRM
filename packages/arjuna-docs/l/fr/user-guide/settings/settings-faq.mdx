...
sectionInfo: Configurez les paramètres et préférences de votre espace de travail ArjunaCRM.
---
...
Vous pouvez le faire dans `Paramètres → Paramètres de l'espace de travail`. Nous espérons vous revoir bientôt, merci d'avoir essayé ArjunaCRM !
</Accordion>
...
ArjunaCRM offre des options flexibles pour contrôler les imports d'emails :
