---
title: Intégrations
info: "Connectez ArjunaCRM à vos outils existants et créez des automatisations personnalisées."
image: /images/user-guide/integrations/plug.png
sectionInfo: Connectez ArjunaCRM à vos outils et flux de travail existants
---
...
ArjunaCRM offre actuellement une intégration native avec :
...
La principale façon de connecter ArjunaCRM à d'autres outils est via notre fonctionnalité **Flux de travail** intégrée :
...
1. Visitez [ArjunaCRM sur Zapier](https://zapier.com/apps/arjuna/integrations)
2. Créez un nouveau Zap avec ArjunaCRM comme déclencheur ou action
3. Générez une clé API dans Paramètres → API & Webhooks
4. Connectez votre espace de travail ArjunaCRM à Zapier
...
- **Architecture flexible** : Étendez les capacités de ArjunaCRM au-delà des fonctionnalités de base
...
L'avenir des intégrations ArjunaCRM est axé sur la communauté, assisté par l'IA, et infiniment extensible.
