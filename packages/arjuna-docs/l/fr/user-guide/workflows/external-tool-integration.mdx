...
info: Ces flux de travail se concentrent sur l'intégration et l'extraction de données de ArjunaCRM via des appels API et des webhooks.
...
Ci-dessous sont des exemples de workflows que vous pourriez déployer pour connecter ArjunaCRM avec le reste de votre ensemble d'outils.

## Cas d'Utilisation d'Ingestion de Données

### Soumissions de Formulaire Web

**Problème** : Vous devez capturer des prospects depuis des formulaires de site web, des pages de destination ou des formulaires de contact directement dans ArjunaCRM.
...
**Solution** : Synchronisez régulièrement les données produit dans ArjunaCRM pour donner aux vendeurs un contexte sur leurs comptes.
...
**Configuration** : Créez une vue dans ArjunaCRM avec tous les destinataires de la newsletter.
...
**Problème** : Vous devez synchroniser les données entre ArjunaCRM et un autre système dans les deux sens.

**Solution** : Combinez des workflows planifiés avec des déclencheurs webhook pour une synchronisation en temps réel.

**De ArjunaCRM à Système Externe** :
...
**Du Système Externe à ArjunaCRM** :
...
**Problème** : Les données provenant de sources externes nécessitent un traitement complexe avant de pouvoir être utilisées dans ArjunaCRM.
