...
description: Votre guide complet des fonctionnalités de ArjunaCRM CRM et des meilleures pratiques.
---

import { CardTitle } from "/snippets/card-title.mdx"

<CardGroup cols={2}>
  <Card href="/l/fr/user-guide/getting-started/what-is-arjuna" img="/images/user-guide/what-is-arjuna/20.png">
    <CardTitle>Getting Started</CardTitle>
    Commencez votre parcours ArjunaCRM avec ces guides essentiels.
  </Card>
  ...
  <Card href="/l/fr/user-guide/integrations-api/apis-overview" img="/images/user-guide/integrations/plug.png">
    ...
    Apprenez à connecter ArjunaCRM à vos autres outils.
  </Card>
  ...
  <Card href="/l/fr/user-guide/settings/workspace-settings" img="/images/user-guide/setup/settings.png">
    ...
    Configurez les paramètres et préférences de votre espace de travail ArjunaCRM.
  </Card>
  ...
  <Card href="/l/fr/user-guide/pricing/billing-and-pricing-faq" img="/images/user-guide/setup/pricing.png">
    ...
    Comprenez comment fonctionne la tarification de ArjunaCRM.
  </Card>
