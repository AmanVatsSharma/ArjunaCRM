---
title: Glossaire
info: "Familiarisez-vous avec la terminologie essentielle utilisée dans ArjunaCRM."
...
L'API (Interface de Programmation d'Applications) permet de connecter ArjunaCRM avec d'autres systèmes logiciels et de créer des intégrations personnalisées.
...
Les Intégrations sont des outils intégrés qui permettent de lier ArjunaCRM avec d'autres logiciels ou systèmes.
...
Les opportunités dans ArjunaCRM CRM sont des affaires potentielles ou des ventes avec des comptes ou des contacts.
...
Les Tâches dans le CRM ArjunaCRM sont des activités assignées concernant des contacts, des comptes ou des opportunités.
...
Les Webhooks sont des messages automatisés envoyés de ArjunaCRM à d'autres applications lorsque des événements spécifiques se produisent, permettant une synchronisation des données en temps réel.
...
Un `Espace de Travail` représente généralement une entreprise utilisant ArjunaCRM. Il contient tous les enregistrements et données que vous et les membres de votre équipe ajoutez à ArjunaCRM.  
...
Les Membres de l'Espace de Travail sont les utilisateurs de ArjunaCRM de votre équipe qui ont accès à votre espace de travail. Ils peuvent être désignés comme propriétaires ou assignés pour les enregistrements.
