...
info: Découvrez les capacités de reporting et d'analytique de ArjunaCRM prévues pour le quatrième trimestre 2025.
...
Suivez notre [répertoire GitHub](https://github.com/vedpragyabharat/arjuna) ou consultez la section **Paramètres → Versions** dans votre espace de travail pour être averti lorsque les fonctionnalités de reporting deviennent disponibles.
