...
ArjunaCRM lie automatiquement les emails de vos boîtes aux lettres connectées aux enregistrements CRM pertinents, gardant tout l'historique de communication en un seul endroit.
...
- **Emails Manquants** : Vérifiez si :
  ...
  - La création automatique de contacts est désactivée (les e-mails nécessitent des enregistrements existants dans ArjunaCRM)
