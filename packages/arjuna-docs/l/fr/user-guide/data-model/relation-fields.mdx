...
Vous pouvez créer des relations avec n'importe quel objet, y compris les **Membres de l'espace de travail** (vos utilisateurs d'équipe ArjunaCRM). Ceci est utile pour créer des champs de possession :
