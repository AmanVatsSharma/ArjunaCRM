...
<Warning>
**Première installation ?** Suivez le [Guide d'installation de Docker Compose](https://docs.vedpragya.com/l/fr/developers/self-hosting/docker-compose) pour faire fonctionner ArjunaCRM, puis revenez ici pour la configuration.
</Warning>

ArjunaCRM offre **deux modes de configuration** pour répondre à différents besoins de déploiement :
...
1. Accédez à votre instance ArjunaCRM (généralement `http://localhost:3000`)
...
[Référence technique complète →](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/arjuna-config/config-variables.ts) </Warning>
...
[Voir le code source pertinent](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
Les utilisateurs doivent avoir une [licence Microsoft 365](https://admin.microsoft.com/Adminportal/Home) pour pouvoir utiliser les API Calendrier et Messagerie. Ils ne pourront pas synchroniser leur compte sur ArjunaCRM sans cela.
</Warning>
...
[Voir le code source pertinent](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
