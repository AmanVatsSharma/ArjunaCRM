...
description: Documentation technique pour les contributeurs et développeurs travaillant avec ArjunaCRM
---
...
<CardGroup cols={2}>
  <Card href="/l/fr/developers/local-setup" img="/images/user-guide/fields/field.png">
    ...
    Le guide pour les contributeurs (ou les développeurs curieux) qui veulent exécuter ArjunaCRM localement (sur un ordinateur portable, PC...)
  </Card>
  ...
  <Card href="/l/fr/developers/self-hosting/docker-compose" img="/images/user-guide/integrations/plug.png">
    ...
    Apprenez à héberger ArjunaCRM sur votre propre serveur
  </Card>
