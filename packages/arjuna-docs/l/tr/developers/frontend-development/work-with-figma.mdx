...
1. **Access the shared link:** You can access the project's Figma file [here](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/ArjunaCRM).
...
On the left sidebar, you can access the different pages of ArjunaCRM's Figma. Bu şekilde organize edilmişlerdir:
...
- **Ana sayfa:** İkinci sayfa ana sayfadır ve projenin tam kullanıcı arayüzünü gösterir. You can press _**Play**_ to use the full app prototype.
