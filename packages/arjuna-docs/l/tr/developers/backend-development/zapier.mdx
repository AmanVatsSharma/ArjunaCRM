...
Zapier'i kullanarak ArjunaCRM'yi 3000+ uygulama ile zahmetsizce senkronize edin. Görevleri otomatikleştirin, verimliliği artırın ve müşteri ilişkilerinizi güçlendirin!
...
`packages/arjuna-zapier` klasöründen şunu çalıştırın:
