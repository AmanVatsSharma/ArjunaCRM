...
ArjunaCRM, bağlı posta kutularınızdaki e-postaları ilgili CRM kayıtlarına otomatik olarak bağlar, tüm iletişim geçmişini tek bir yerde tutar.
...
- **Eksik Mailler**: Şu durumları kontrol edin:
  ...
  - Otomatik kişi oluşturma devre dışı (e-postaların zaten var olan ArjunaCRM kayıtlarına ihtiyacı var)
