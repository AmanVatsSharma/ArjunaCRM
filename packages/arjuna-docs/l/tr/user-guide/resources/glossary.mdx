---
title: Sözlük
info: "ArjunaCRM'de kullanılan temel terminolojiyle tanışın."
...
API (Uygulama Programlama Arayüzü), ArjunaCRM'yi diğer yazılım sistemleriyle bağlamanızı ve özel entegrasyonlar oluşturmanızı sağlar.
...
Entegrasyon, ArjunaCRM'yi diğer yazılım veya sistemlerle bağlamanızı sağlayan yerleşik araçlardır.
...
ArjunaCRM CRM'deki Fırsatlar, hesaplar veya kişilerle potansiyel anlaşmalar veya satışlardır.
...
ArjunaCRM CRM'deki Görevler, kişilere, hesaplara veya fırsatlara ilişkin atanmış aktiviteleridir.
...
Webhook'lar, belirli olaylar gerçekleştiğinde ArjunaCRM'den diğer uygulamalara gönderilen otomatik mesajlardır ve gerçek zamanlı veri senkronizasyonu sağlar.
...
Bir `Çalışma Alanı` genellikle ArjunaCRM'yi kullanan bir şirketi temsil eder. It holds all the records and data that you and your team members add to ArjunaCRM.  
...
Çalışma Alanı Üyeleri, takımınızdan ArjunaCRM kullanıcıları olup, çalışma alanınıza erişebilirler. Kayıtlara sahip olarak veya atananlar olarak atanabilirler.
