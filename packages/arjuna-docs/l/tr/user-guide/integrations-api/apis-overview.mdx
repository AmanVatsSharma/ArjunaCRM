...
sectionInfo: ArjunaCRM'yi diğer araçlarınıza nasıl bağlayacağınızı öğrenin.
---
...
ArjunaCRM, geliştirici dostu olacak şekilde tasarlanmıştır ve özel veri modelinize uyum sağlayan güçlü API'ler sunar. Farklı entegrasyon ihtiyaçlarını karşılamak üzere dört farklı API türü sunuyoruz.

## Öncelik Geliştiricide Yaklaşımı

ArjunaCRM, veri modeliniz için özel olarak API'ler oluşturur, yani:
...
ArjunaCRM, **REST** ve **GraphQL** formatlarında API'ler sunmaktadır:
