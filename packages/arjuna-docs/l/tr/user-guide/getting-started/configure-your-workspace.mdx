...
sectionInfo: ArjunaCRM adlı açık kaynaklı CRM'yi keşfedin.
---
...
Her iş farklı çalışır. Bu yüzden ArjunaCRM, ihtiyaçlarınıza göre CRM'i şekillendirmenize olanak tanır, süreçlerinizi bize uydurmanıza zorlamaz.
**Start with these three steps to set it up your way.**

**Hızlı Kazanç**: Posta kutunuzu bağlamak ve birkaç anahtar alanla veri modelinizi özelleştirmekle başlayın. Bu size anında değer katar ve ekibinizin gerçek verilerle ArjunaCRM'yi çalışırken görmesine yardımcı olur. Ayarlar → Hesaplar altında bu işlemi gerçekleştirebilirsiniz.

## 1. Veri modelinizi özelleştirin

ArjunaCRM, günlük ihtiyaçlarınızı en iyi şekilde destekleyecek veri modelini şekillendirmeniz için ihtiyaç duyduğunuz esnekliği sunar.
...
Veri modelinizi tasarlamayı öğrenmek için [bu makaleyi](https://docs.vedpragya.com/l/tr/user-guide/data-model/customize-your-data-model) okuyabilirsiniz.

## 2. Verilerinizi yükleyin

Mevcut verilerinizi ArjunaCRM'ye getirmek, ekibinize baştan itibaren bağlam sunar.

### Posta kutunuzu bağlayın

Çalışma alanınızı oluştururken bunu yapmadıysanız, Ayarlar → Hesaplar altında **Google veya Microsoft hesabınızı** bağlayın. Bu, ArjunaCRM'ye şunları yapma olanağı tanır:
...
[İş akışlarını](https://docs.vedpragya.com/l/tr/user-guide/workflows/getting-started-workflows) kullanarak otomasyonlar oluşturmaya başlayın.
