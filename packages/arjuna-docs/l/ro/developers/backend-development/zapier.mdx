...
Sincronizează fără efort ArjunaCRM cu peste 3000 de aplicații folosind [Zapier](https://zapier.com/). Automatizează sarcinile, stimulează productivitatea și îmbunătățește relațiile cu clienții!
...
Din folderul `packages/arjuna-zapier`, rulează:
