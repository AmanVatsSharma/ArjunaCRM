...
sectionInfo: Află cum să conectezi ArjunaCRM cu celelalte instrumente ale tale.
---
...
ArjunaCRM a fost creat pentru a fi prietenos cu dezvoltatorii, oferind API-uri puternice care se adaptează la modelul dvs. de date personalizat. Oferim patru tipuri distincte de API-uri pentru a satisface diferite nevoi de integrare.

## Developer-First Approach

ArjunaCRM generează API-uri special pentru modelul dvs. de date, ceea ce înseamnă:
...
ArjunaCRM oferă API-uri în formate **REST** și **GraphQL**:
