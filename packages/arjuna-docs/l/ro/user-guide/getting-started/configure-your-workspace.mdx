...
Fiecare afacere funcționează diferit. De aceea ArjunaCRM îți permite să modelezi CRM-ul în funcție de nevoile tale, nu să îți forțeze procesele să se conformeze cu ale noastre.
**Start with these three steps to set it up your way.**

**Quick Win**: Start with connecting your mailbox and customizing your data model with a few key fields. Acest lucru îți oferă valoare imediată și ajută echipa ta să vadă ArjunaCRM în acțiune cu date reale. Poți face asta în setări → Conturi.

## 1. Personalizează modelul de date

ArjunaCRM oferă flexibilitatea de care ai nevoie pentru a modela modelul de date care va susține cel mai bine activitățile tale zilnice.
...
Citește [acest articol](https://docs.vedpragya.com/l/ro/user-guide/data-model/customize-your-data-model) pentru a afla cum să îți proiectezi modelul de date.

## 2. Importă datele tale

Importarea datelor existente în ArjunaCRM oferă echipei tale context de la început.

### Conectează-ți căsuța de e-mail

Dacă nu ai făcut asta atunci când ai creat spațiul de lucru, conectează-ți **contul Google sau Microsoft** în setări → Conturi. Acest lucru permite ArjunaCRM să:
...
Începe să creezi automatizări folosind [fluxuri de lucru](https://docs.vedpragya.com/l/ro/user-guide/workflows/getting-started-workflows).
