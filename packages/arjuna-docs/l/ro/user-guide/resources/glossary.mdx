---
title: Glosar
info: "Familiarizați-vă cu terminologia esențială utilizată în ArjunaCRM."
...
API (Interfața de Programare a Aplicațiilor) permite conectarea ArjunaCRM cu alte sisteme software și construirea de integrări personalizate.
...
Integrările sunt instrumente încorporate care permit conectarea ArjunaCRM cu alte programe sau sisteme.
...
Oportunitățile în ArjunaCRM CRM sunt potențiale afaceri sau vânzări cu conturi sau contacte.
...
Sarcinile în ArjunaCRM CRM sunt activități atribuite care au legătură cu contacte, conturi sau oportunități.
...
Webhook-urile sunt mesaje automate trimise de la ArjunaCRM către alte aplicații atunci când au loc evenimente specifice, permițând sincronizarea datelor în timp real.
...
Un `Spațiu de Lucru` reprezintă de obicei o companie care folosește ArjunaCRM. Ține toate înregistrările și datele pe care dumneavoastră și membrii echipei dumneavoastră le adăugați la ArjunaCRM.  
...
Membrii Spațiului de Lucru sunt utilizatorii ArjunaCRM din echipa dumneavoastră care au acces la spațiul dvs. de lucru. Ei pot fi desemnați ca proprietari sau atribuți pentru înregistrări.
