...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/he/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

ArjunaCRM מציעה **שני מצבי תצורה** כדי להתאים לצרכים שונים של פריסה:
...
1. גש למופע ArjunaCRM שלך (בדרך כלל `http://localhost:3000`)
...
[ראה מקור קוד רלוונטי](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
על המשתמשים להחזיק ב-[רישיון של Microsoft 365](https://admin.microsoft.com/Adminportal/Home) כדי להשתמש ב-API של לוח שנה והודעות. ללא אחד כזה, הם לא יוכלו לסנכרן את החשבון שלהם על גבי ArjunaCRM.
</Warning>
...
[ראה מקור קוד רלוונטי](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
