...
sectionInfo: הגדר את העדפות וההגדרות של מרחב העבודה של ArjunaCRM שלך
---
...
באפשרותך לעשות זאת תחת `הגדרות → הגדרות שטח עבודה`. אנו מקווים שנפגוש אותך בקרוב, תודה שנתת ל-ArjunaCRM הזדמנות!
</Accordion>
...
לא, אנחנו לא מספקים כתובת מייל להעתקה לצורך סנכרון סלקטיבי. במקום זאת, אנו מציעים את התכונה של תיקיית הודעות אשר מעניקה לך את אותה רמת שליטה. באפשרותך לבחור בדיוק אילו תיקיות יסונכרנו עם ArjunaCRM, בכך שתשלוט בדיוק אילו מיילים יופיעו ב-CRM שלך מבלי שתצטרך לזכור להעביר לכתובת ייחודית.
</Accordion>
...
כן! עבור אל `הגדרות → דומיינים` כדי להגדיר דומיין מותאם לשטח העבודה (למשל, yourcompany.vedpragya.com) ולהגדיר דומיינים מאושרים כך שחברי צוות עם כתובת מייל של החברה יוכלו להצטרף אוטומטית לשטח העבודה שלך.
</Accordion>
