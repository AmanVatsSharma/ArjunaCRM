---
title: 워크스페이스 만들기
info: "ArjunaCRM에 등록하고, 구독 계획을 선택하며, 결제를 확인하고 계정을 설정하는 단계별 안내를 따르세요. 필요한 경우 도움을 받는 방법에 대한 추가 조언도 포함되어 있습니다."
...
1. [ArjunaCRM 등록](https://app.vedpragya.com)으로 이동하세요.
...
문의 사항이나 도움이 필요하시면, [contact@vedpragya.com](mailto:contact@vedpragya.com)으로 전용 지원팀에 연락하거나 [Discord](https://discord.gg/cx5n4Jzs57)에서 메시지를 보내주세요.
