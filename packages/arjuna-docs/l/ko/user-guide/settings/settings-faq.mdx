...
sectionInfo: ArjunaCRM 워크스페이스 설정 및 환경설정을 구성하세요.
---
...
이는 `설정 → 워크스페이스 설정`에서 할 수 있습니다. 곧 다시 뵙길 바랍니다. ArjunaCRM를 사용해 주셔서 감사합니다!
</Accordion>
...
아니요, 선택적 동기화를 위한 CC 이메일 주소를 제공하지 않습니다. 대신, 동일한 수준의 제어를 제공하는 메시지 폴더 기능을 제공합니다. 어떤 폴더가 ArjunaCRM와 동기화될지를 정확히 선택할 수 있어 특수한 주소를 기억하지 않고도 CRM에 표시될 이메일을 정확히 제어할 수 있습니다.
</Accordion>
...
예! `설정 → 도메인`으로 이동하여 사용자 지정 워크스페이스 도메인(yourcompany.vedpragya.com) 및 팀원이 회사 이메일 주소로 자동으로 워크스페이스에 가입할 수 있도록 승인된 접근 도메인을 구성하세요.
</Accordion>
