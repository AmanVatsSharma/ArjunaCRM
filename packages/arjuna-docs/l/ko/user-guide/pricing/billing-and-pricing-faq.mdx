...
sectionInfo: ArjunaCRM의 가격 책정 방식 이해.
---
...
네, 자기 호스팅할 때 ArjunaCRM를 무료로 사용할 수 있습니다. You will get access to everything included in the (cloud) Pro subscription, except the support from our core-team. 지원은 Discord 커뮤니티를 통해 제공됩니다.
...
무료 좌석은 제공되지 않습니다. 가격은 사용자당 책정되며, 각 사용자는 ArjunaCRM에 접근하기 위해 라이센스가 필요합니다.
</Accordion>
