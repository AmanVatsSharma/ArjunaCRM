...
ArjunaCRM는 개발자 친화적으로 설계되어 있으며, 맞춤형 데이터 모델에 적합한 강력한 API를 제공합니다. 우리는 여러 통합 요구에 맞는 네 가지 고유한 API 유형을 제공합니다.

## 개발자 우선 접근 방식

ArjunaCRM는 귀하의 데이터 모델에 맞는 API를 특별히 생성합니다. 즉:
...
ArjunaCRM는 **REST** 및 **GraphQL** 형식으로 API를 제공합니다:
