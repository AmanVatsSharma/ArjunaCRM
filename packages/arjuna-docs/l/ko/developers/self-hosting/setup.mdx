...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/ko/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

ArjunaCRM는 다른 배포 요구에 맞추기 위해 **두 가지 구성 모드**를 제공합니다:
...
1. ArjunaCRM 인스턴스에 접근하십시오 (보통 `http://localhost:3000`)
...
**필요한 범위** (자동 구성됨):
[관련 소스 코드 보기](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
사용자는 캘린더 및 메시징 API를 사용하려면 [Microsoft 365 라이선스](https://admin.microsoft.com/Adminportal/Home)를 보유해야 합니다. 없이는 ArjunaCRM에서 계정을 동기화할 수 없습니다.
</Warning>
...
[관련 소스 코드 보기](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
