...
Легко синхронизируйте ArjunaCRM с более чем 3000 приложениями с помощью [Zapier](https://zapier.com/). Автоматизируйте задачи, повышайте продуктивность и улучшайте ваши отношения с клиентами!
...
В каталоге `packages/arjuna-zapier` выполните:
