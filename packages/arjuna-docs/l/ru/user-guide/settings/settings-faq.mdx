...
sectionInfo: Настройте параметры и предпочтения рабочей области ArjunaCRM
---
...
Сделать это можно в `Настройки → Настройки рабочей области`. Надеемся, скоро увидеть вас снова, спасибо, что попробовали ArjunaCRM!
</Accordion>
...
No, we don't provide a CC email address for selective syncing. Вместо этого мы предлагаем функцию папок сообщений, которая предоставляет вам тот же уровень контроля. Вы можете точно выбрать, какие папки синхронизируются с ArjunaCRM, давая вам точный контроль над тем, какие письма появляются в вашей CRM, без необходимости помнить о том, чтобы добавлять особый адрес в копию.
</Accordion>
...
Да! Перейдите в `Настройки → Домены`, чтобы настроить пользовательский домен рабочего пространства (например, ваша компания.vedpragya.com) и настроить подтверждённые домены доступа, чтобы члены команды с корпоративными адресами электронной почты могли автоматически присоединяться к вашему рабочему пространству.
</Accordion>
