...
sectionInfo: Поймите, как работают цены ArjunaCRM.
---
...
Да, вы можете использовать ArjunaCRM бесплатно при самостоятельном размещении. Вы получите доступ ко всему, что включено в подписку (облако) Pro, за исключением поддержки от нашей основной команды. Поддержка доступна через наше сообщество Discord.
...
Мы не предлагаем бесплатные места. Стоимость рассчитывается на каждого пользователя, и каждый пользователь нуждается в лицензии для доступа к ArjunaCRM.
</Accordion>
