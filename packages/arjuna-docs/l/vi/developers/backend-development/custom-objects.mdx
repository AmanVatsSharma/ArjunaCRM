...
Các đối tượng là cấu trúc cho phép bạn lưu trữ dữ liệu (bản ghi, thuộc tính và giá trị) đặc trưng cho một tổ chức. ArjunaCRM cung cấp cả đối tượng tiêu chuẩn và đối tượng tùy chỉnh.

Đối tượng tiêu chuẩn là đối tượng tích hợp sẵn với một bộ thuộc tính có sẵn cho tất cả người dùng. Ví dụ về đối tượng tiêu chuẩn trong ArjunaCRM bao gồm Company và Person. Đối tượng tiêu chuẩn có các trường chuẩn cũng có sẵn cho tất cả người dùng ArjunaCRM, như Company.displayName.
