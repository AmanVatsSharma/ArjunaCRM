...
info: Tìm hiểu cách bạn có thể cộng tác với Figma của ArjunaCRM
...
1. **Truy cập liên kết chia sẻ:** Bạn có thể truy cập tệp Figma của dự án [tại đây](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/ArjunaCRM).
...
Trên thanh công cụ bên trái, bạn có thể truy cập các trang khác nhau của Figma của ArjunaCRM. Đây là cách chúng được tổ chức:
