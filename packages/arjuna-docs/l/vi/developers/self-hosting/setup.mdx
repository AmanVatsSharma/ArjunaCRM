...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/vi/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

ArjunaCRM cung cấp **hai chế độ cấu hình** phù hợp với các nhu cầu triển khai khác nhau:
...
1. Truy cập phiên bản ArjunaCRM của bạn (thường là `http://localhost:3000`)
...
[Xem mã nguồn liên quan](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
Người dùng phải có [Giấy phép Microsoft 365](https://admin.microsoft.com/Adminportal/Home) để có thể sử dụng API Lịch và Nhắn tin. Họ không thể đồng bộ hóa tài khoản của mình trên ArjunaCRM mà không có giấy phép.
</Warning>
...
[Xem mã nguồn liên quan](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
