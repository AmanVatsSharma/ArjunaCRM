...
Khi bạn bắt đầu sử dụng ArjunaCRM, bạn sẽ muốn đưa danh bạ và công ty của mình vào hệ thống. Có nhiều cách để nhập dữ liệu vào CRM tùy thuộc vào quy trình làm việc và nguồn dữ liệu của bạn.

### Nhập thủ công

Cách tiếp cận đơn giản nhất là thêm hồ sơ trực tiếp qua giao diện ArjunaCRM. Đi đến phần `Người` và nhấp vào nút `+` để thêm một liên hệ mới. Điền tên, email, điện thoại của họ và liên kết họ với công ty của họ. Đối với công ty, hãy chuyển đến phần `Công ty` và thêm chi tiết tổ chức: tên công ty, tên miền, ngành và quy mô.
...
Đối với việc tạo khách hàng tiềm năng đang diễn ra, bạn có thể thiết lập quy trình tự động để đưa dữ liệu trực tiếp vào ArjunaCRM:

**Biểu mẫu website**: Khi ai đó điền vào biểu mẫu trên trang web của bạn, bạn có thể cấu hình để tự động gửi thông tin đó đến ArjunaCRM. Việc nộp biểu mẫu kích hoạt webhook kích hoạt quy trình trong ArjunaCRM, tạo bản ghi liên hệ mới mà không cần bất kỳ thao tác thủ công nào.

**Tích hợp với các hệ thống khác**: Nếu bạn sử dụng các công cụ kinh doanh khác, bạn có thể kết nối chúng với ArjunaCRM bằng các cuộc gọi API và quy trình. Điều này cho phép bạn đồng bộ hóa dữ liệu giữa các hệ thống tự động: ví dụ, đưa vào khách hàng mới từ hệ thống thanh toán của bạn hoặc từ nền tảng tiếp thị của bạn.
...
Khi bạn kết nối hộp thư và lịch vào ArjunaCRM, hệ thống có thể tự động tạo các hồ sơ Người và Công ty cho những người bạn email hoặc gặp mặt. Nếu bạn gửi email cho ai đó chưa có trong CRM của bạn, ArjunaCRM có thể tạo một bản ghi mới cho họ. Điều tương tự cũng xảy ra khi bạn lên lịch cuộc họp với các liên hệ mới thông qua lịch của bạn.

Điều này đặc biệt hữu ích cho các nhóm bán hàng và phát triển kinh doanh luôn gặp gỡ người mới. Thay vì thêm mỗi liên hệ mới thủ công, ArjunaCRM sẽ tự động ghi lại họ khi bạn giao tiếp. Tìm hiểu cách thiết lập điều này trong hướng dẫn [Email và Lịch](/l/vi/user-guide/collaboration/emails-and-calendars) của chúng tôi.
...
ArjunaCRM tự động áp dụng tính độc nhất để giữ dữ liệu của bạn có tổ chức. Email của mỗi người phục vụ như một nhận dạng duy nhất: bạn không thể có hai người có cùng email. Tương tự, các tên miền công ty là duy nhất, vì vậy bạn sẽ không vô tình tạo các công ty trùng lặp.
...
Đôi khi bạn sẽ kết thúc với các bản ghi trùng lặp. ArjunaCRM có tính năng hợp nhất cho cả Người và Công ty: bạn có thể kết hợp các bản ghi trùng lặp để giữ cho cơ sở dữ liệu của bạn sạch sẽ mà không mất thông tin nào.
...
Các tab Email và Lịch đặc biệt mạnh mẽ: chúng tự động hiển thị tất cả các trao đổi email và cuộc họp mà bất kỳ ai trong nhóm của bạn đã có với liên hệ này, miễn là họ đã kết nối hộp thư của mình với ArjunaCRM. Bạn có thể tìm hiểu thêm về cách thiết lập điều này trong hướng dẫn [Email và Lịch](/l/vi/user-guide/collaboration/emails-and-calendars) của chúng tôi.
...
When you delete a record in ArjunaCRM, it's not gone forever. Các bản ghi được "xóa mềm", có nghĩa là chúng bị ẩn nhưng có thể được khôi phục nếu cần.
