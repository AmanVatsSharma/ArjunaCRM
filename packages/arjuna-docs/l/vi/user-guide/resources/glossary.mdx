---
title: Thuật ngữ
info: "Làm quen với thuật ngữ cần thiết được sử dụng trong ArjunaCRM."
...
API (Giao diện Lập trình Ứng dụng) cho phép bạn kết nối ArjunaCRM với các hệ thống phần mềm khác và xây dựng các tích hợp tùy chỉnh.
...
Tích hợp là các công cụ tích hợp sẵn cho phép liên kết ArjunaCRM với phần mềm hoặc hệ thống khác.
...
Webhooks là các tin nhắn tự động gửi từ ArjunaCRM đến các ứng dụng khác khi các sự kiện cụ thể xảy ra, cho phép đồng bộ hóa dữ liệu theo thời gian thực.
...
A `Workspace` typically represents a company using ArjunaCRM. It holds all the records and data that you and your team members add to ArjunaCRM.  
