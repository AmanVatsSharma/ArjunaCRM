...
- Các mối quan hệ giữa các đối tượng trong ArjunaCRM là "Một với Nhiều". Điều này có nghĩa là mỗi bản ghi của đối tượng A có thể được đính kèm với nhiều bản ghi của đối tượng B. Nhưng mỗi bản ghi của đối tượng B có thể chỉ thuộc một bản ghi của đối tượng A.
...
Có. Bạn cần tạo một trường mà bạn xác định là duy nhất trong mô hình dữ liệu của bạn và sẽ chứa `id` từ công cụ khác của bạn. Xin lưu ý rằng tên `id` được bảo vệ vì nó được sử dụng cho id của ArjunaCRM.  
