...
In `arjuna-front` kun je echter conflicten hebben tussen dezelfde sneltoetsen die in verschillende onderdelen worden gebruikt, die op hetzelfde moment geladen zijn.
