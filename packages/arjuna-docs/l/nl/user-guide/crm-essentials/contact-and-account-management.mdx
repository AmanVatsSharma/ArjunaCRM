...
Wanneer u begint met het gebruik van ArjunaCRM, wilt u uw contacten en bedrijven in het systeem krijgen. Er zijn verschillende manieren om uw CRM te vullen, afhankelijk van uw workflow en gegevensbronnen.

### Handmatige invoer

De meest eenvoudige benadering is het direct toevoegen van gegevens via de ArjunaCRM interface. Ga naar het gedeelte 'Personen' en klik op de '+' knop om een nieuw contact toe te voegen. Vul hun naam, e-mail, telefoonnummer in en koppel hen aan hun bedrijf. Voor bedrijven gaat u naar het gedeelte 'Bedrijven' en voegt u de organisatiedetails toe: bedrijfsnaam, domein, industrie en grootte.
...
Voor lopende leadgeneratie kunt u geautomatiseerde workflows instellen die gegevens direct in ArjunaCRM brengen:

**Websiteformulieren**: Wanneer iemand een formulier op uw website invult, kunt u het configureren om de informatie automatisch naar ArjunaCRM te sturen. Het indienen van het formulier activeert een webhook die een workflow in ArjunaCRM activeert, die een nieuw contact aanmaakt zonder enige handmatige inspanning.

**Integratie met andere systemen**: Als u andere zakelijke hulpmiddelen gebruikt, kunt u deze verbinden met ArjunaCRM door middel van API-aanroepen en workflows. Hiermee kunt u gegevens automatisch tussen systemen synchroniseren: bijvoorbeeld het binnenhalen van nieuwe klanten uit uw factureringssysteem of leads uit uw marketingplatform.
...
Wanneer u uw mailbox en agenda met ArjunaCRM verbindt, kan het systeem automatisch Personen- en Bedrijfsrecords aanmaken voor mensen die u e-mailt of ontmoet. Als u een e-mail stuurt naar iemand die nog niet in uw CRM staat, kan ArjunaCRM een nieuw Persoonsrecord voor hen aanmaken. Hetzelfde gebeurt wanneer u afspraken plant met nieuwe contacten via uw agenda.

Dit is bijzonder nuttig voor verkoop- en bedrijfsontwikkelingsteams die constant nieuwe mensen ontmoeten. In plaats van handmatig elke nieuwe contactpersoon toe te voegen, vangt ArjunaCRM ze automatisch op terwijl u communiceert. Leer hoe u dit kunt instellen in onze [E-mails en Agenda's](/l/nl/user-guide/collaboration/emails-and-calendars) gids.
...
ArjunaCRM dwingt automatisch uniekheid af om uw gegevens georganiseerd te houden. Het e-mailadres van elke persoon dient als een unieke identificatie: u kunt niet twee personen hebben met hetzelfde e-mailadres. Evenzo zijn bedrijfsdomeinen uniek, zodat u niet per ongeluk dubbele bedrijven aanmaakt.
...
Sometimes you'll end up with duplicate records. ArjunaCRM heeft een samenvoegfunctie voor zowel Personen als Bedrijven: u kunt dubbele records samenvoegen om uw database schoon te houden zonder verlies van informatie.
...
Wanneer u een record in ArjunaCRM verwijdert, is het niet definitief weg. Records worden "zacht verwijderd", wat betekent dat ze verborgen zijn maar hersteld kunnen worden indien nodig.
