...
info: Deze workflows richten zich op het importeren en exporteren van data in en uit ArjunaCRM via API-oproepen en webhooks.
...
Hieronder staan workflowvoorbeelden die u kunt uitrollen om ArjunaCRM met de rest van uw stack te verbinden.

## Gegevensinvoer Gebruikssituaties

### Webformulier Inzendingen

**Probleem**: U moet leads van websiteformulieren, landingspagina's of contactformulieren direct invoeren in ArjunaCRM.
...
**Oplossing**: Synchroniseer regelmatig productgegevens naar ArjunaCRM om verkopers context te geven over hun accounts.
...
**Instellen**: Maak een weergave in ArjunaCRM met alle nieuwsbriefontvangers.
...
**Probleem**: U moet gegevens tussen ArjunaCRM en een ander systeem in beide richtingen synchroniseren.

**Oplossing**: Combineer geplande workflows met webhook-triggers voor realtime synchronisatie.

**Van ArjunaCRM naar Extern Systeem**:
...
**Van Extern Systeem naar ArjunaCRM**:
...
**Probleem**: Gegevens van externe bronnen vereisen complexe verwerking voordat ze in ArjunaCRM gebruikt kunnen worden.
