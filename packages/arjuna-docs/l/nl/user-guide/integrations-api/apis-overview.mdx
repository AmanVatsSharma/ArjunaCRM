...
sectionInfo: Leer hoe je ArjunaCRM met je andere tools verbindt.
---
...
ArjunaCRM is ontwikkeld met ontwikkelaars in gedachten, en biedt krachtige API's die zich aanpassen aan je aangepaste datamodel. We bieden vier verschillende API-typen om aan uiteenlopende integratiebehoeften te voldoen.

## Developer-First Approach

ArjunaCRM genereert API's specifiek voor je datamodel, dat betekent:
...
ArjunaCRM biedt API's in zowel **REST** als **GraphQL** formaten:
