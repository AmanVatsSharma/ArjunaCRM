...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/ar/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

يوفر ArjunaCRM **وضعين للإعداد** ليلائم احتياجات النشر المختلفة:
...
1. الوصول إلى نسخة ArjunaCRM الخاصة بك (عادة `http://localhost:3000`)
...
[انظر الشيفرة المصدرية ذات الصلة](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
يجب على المستخدمين الحصول على [ترخيص Microsoft 365](https://admin.microsoft.com/Adminportal/Home) ليتمكنوا من استخدام تقويم API ورسائل. لن يتمكنوا من مزامنة حسابهم في ArjunaCRM دون واحد منها.
</Warning>
...
[انظر الشيفرة المصدرية ذات الصلة](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
