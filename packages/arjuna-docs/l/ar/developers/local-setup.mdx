...
قبل أن تتمكن من تثبيت واستخدام ArjunaCRM، تأكد من تثبيت الأمور التالية على جهاز الكمبيوتر الخاص بك:
...
يتطلب ArjunaCRM مخزن بيانات Redis لتقديم أفضل أداء
...
استخدم متغيرات البيئة أو ملفات `.env` لتكوين مشروعك. المزيد من المعلومات [هنا](https://docs.vedpragya.com/l/ar/developers/self-hosting/setup)
...
لبناء خادم ArjunaCRM وزرع بعض البيانات في قاعدة البيانات الخاصة بك، قم بتشغيل الأمر التالي:
...
## الخطوة الثامنة: استخدم ArjunaCRM

**الواجهة الأمامية**

ستكون واجهة ArjunaCRM الأمامية تعمل على  [http://localhost:3001](http://localhost:3001).
يمكنك تسجيل الدخول باستخدام حساب العرض التوضيحي الافتراضي: `tim@apple.dev` (كلمة المرور: `tim@apple.dev`)

**الخلفية**

- سيكون خادم ArjunaCRM متصلاً ويعمل على [http://localhost:3000](http://localhost:3000)
