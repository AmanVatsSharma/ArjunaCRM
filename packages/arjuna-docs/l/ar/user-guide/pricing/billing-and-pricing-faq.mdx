...
sectionInfo: افهم كيف تعمل تسعيرات ArjunaCRM.
---
...
نعم، يمكنك استخدام ArjunaCRM مجانًا أثناء الاستضافة الذاتية. ستحصل على الوصول إلى كل شيء مضمّن في اشتراك (السحابة) للمحترفين، باستثناء الدعم من فريقنا الأساسي. الدعم متاح عبر مجتمعنا في Discord.
...
نحن لا نقدم مقاعد مجانية. التسعير يكون لكل مستخدم وكل مستخدم يحتاج إلى ترخيص للوصول إلى ArjunaCRM.
</Accordion>
