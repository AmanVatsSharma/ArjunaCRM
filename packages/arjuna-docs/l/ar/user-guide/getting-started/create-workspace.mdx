...
info: "اتبع الدليل خطوة بخطوة حول كيفية التسجيل في ArjunaCRM، اختر خطة الاشتراك، قم بتأكيد الدفع وقم بإعداد حسابك، مع نصائح إضافية حول كيفية الحصول على المساعدة إذا لزم الأمر."
image: /images/user-guide/create-workspace/workspace-cover.png
sectionInfo: اكتشف ArjunaCRM، برنامج CRM مفتوح المصدر.
---
...
1. انتقل إلى [الاشتراك في ArjunaCRM](https://app.vedpragya.com).
...
للاستفسارات أو المساعدة، تواصل مع فريق الدعم المتخصص عبر [contact@vedpragya.com](mailto:contact@vedpragya.com) أو أرسل رسالة على [Discord](https://discord.gg/cx5n4Jzs57)
