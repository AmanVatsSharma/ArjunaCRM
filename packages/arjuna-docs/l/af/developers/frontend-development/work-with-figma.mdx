...
info: Leer hoe jy met ArjunaCRM se Figma kan saamwerk
...
1. **Toegang tot die gedeelde skakel:** Jy kan toegang verkry tot die projek se Figma-lêer [hier](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/ArjunaCRM).
...
Aan die linkerkantste kantbalk kan jy toegang kry tot die verskillende bladsye van ArjunaCRM se Figma. Dit is hoe hulle georganiseer is:
