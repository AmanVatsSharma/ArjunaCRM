...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/af/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

ArjunaCRM bied **twee konfigurasiemodusse** aan om by verskillende implementeringsbehoeftes te pas:
...
1. Verkry toegang tot jou ArjunaCRM-instansie (gewoonlik `http://localhost:3000`)
...
[Sien relevante bronkode](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
Gebruikers moet 'n [Microsoft 365 Lisensie](https://admin.microsoft.com/Adminportal/Home) hê om van die Kalender en Boodskap API gebruik te kan maak. Hulle sal nie hul rekening op ArjunaCRM sonder een kan sinchroniseer nie.
</Warning>
...
[Sien relevante bronkode](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
