...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/sv/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

ArjunaCRM erbjuder **två konfigurationslägen** för att möta olika implementeringsbehov:
...
1. Anslut till din ArjunaCRM-instans (vanligtvis `http://localhost:3000`)
...
[Se relevant källkod](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
Användare måste ha en [Microsoft 365-licens](https://admin.microsoft.com/Adminportal/Home) för att kunna använda kalender- och meddelande-API:et. De kommer inte att kunna synkronisera sitt konto på ArjunaCRM utan en.
</Warning>
...
[Se relevant källkod](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
