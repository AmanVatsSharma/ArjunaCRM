...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/it/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

ArjunaCRM offre **due modalità di configurazione** per soddisfare diverse esigenze di distribuzione:
...
1. Accedi alla tua istanza ArjunaCRM (solitamente `http://localhost:3000`)
...
[Complete technical reference →](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/arjuna-config/config-variables.ts) </Warning>
...
**Scope richiesti** (configurati automaticamente): [Vedi il codice sorgente pertinente](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
Gli utenti devono avere una [Licenza Microsoft 365](https://admin.microsoft.com/Adminportal/Home) per poter utilizzare l'API Calendario e Messaggi. Non potranno sincronizzare il loro account su ArjunaCRM senza una.
</Warning>
...
[Vedi il codice sorgente pertinente](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
