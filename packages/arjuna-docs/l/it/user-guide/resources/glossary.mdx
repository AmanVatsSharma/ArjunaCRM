---
title: Glossario
info: "Familiarizza con la terminologia essenziale utilizzata in ArjunaCRM."
...
Le API (Interfaccia di Programmazione delle Applicazioni) ti consentono di connettere ArjunaCRM con altri sistemi software e creare integrazioni personalizzate.
...
Le Opportunità in ArjunaCRM CRM sono potenziali accordi o vendite con conti o contatti.
...
Le Attività in ArjunaCRM CRM sono attività assegnate relative a contatti, conti o opportunità.
...
Un `Workspace` rappresenta tipicamente un'azienda che utilizzano ArjunaCRM. Contiene tutti i record e i dati che tu e i membri del tuo team aggiungete a ArjunaCRM.  
...
I Membri del Workspace sono gli utenti di ArjunaCRM del tuo team che hanno accesso al tuo workspace. Possono essere assegnati come proprietari o assegnatari per i record.
