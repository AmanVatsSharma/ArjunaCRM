...
4. Autorizza ArjunaCRM ad accedere al tuo Gmail e Google Calendar
...
4. Autorizza ArjunaCRM ad accedere al tuo Outlook e Microsoft Calendar
5. Le tue email e gli eventi del calendario inizieranno a sincronizzarsi automaticamente
...
<Warning>
Solo vere caselle di posta possono essere collegate (es. supporto@dominio.com con la propria inbox). Alias email che inoltrano ad un'altra casella non possono essere collegati a ArjunaCRM.
</Warning>
...
Controlla quali cartelle email sincronizzano con ArjunaCRM:
...
**Nota**: Non forniamo un indirizzo email CC per la sincronizzazione selettiva. Invece, usa la funzionalità Cartella Messaggi sopra per ottenere lo stesso livello di controllo su quali email sincronizzano con ArjunaCRM.
