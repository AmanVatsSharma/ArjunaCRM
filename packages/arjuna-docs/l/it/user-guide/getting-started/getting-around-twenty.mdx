...
Quando accedi a ArjunaCRM per la prima volta, il layout dovrebbe sembrare intuitivo. È progettato per aiutarti a muoverti velocemente e rimanere organizzato, senza intralciarti.
...
Il menu di comando ti offre **accesso rapido alle azioni e alla ricerca** in ArjunaCRM. Puoi accedervi in due modi:
...
- Creare nuove viste
- Accedere ai record eliminati (ArjunaCRM supporta eliminazioni temporanee e definitive)
