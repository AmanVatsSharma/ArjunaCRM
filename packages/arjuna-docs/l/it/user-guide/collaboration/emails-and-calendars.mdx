...
**Nota**: Per connettere i tuoi account email e configurare le impostazioni di sincronizzazione, visita [Configurazione Email e Calendario](/l/it/user-guide/settings/email-calendar-setup).

## Come funziona l'integrazione dell'email

ArjunaCRM collega automaticamente le email dalle tue caselle di posta connesse ai relativi record CRM, mantenendo la cronologia di comunicazione in un unico posto.
...
- **Email mancanti**: Verifica se:
  ...
  - La creazione automatica dei contatti è disabilitata (le email necessitano di record ArjunaCRM esistenti)
