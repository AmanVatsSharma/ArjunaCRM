...
sectionInfo: Impara a collegare ArjunaCRM ai tuoi altri strumenti.
---
...
ArjunaCRM was built to be developer-friendly, offering powerful APIs that adapt to your custom data model. Forniamo quattro tipi distinti di API per soddisfare diverse esigenze di integrazione.

## Approccio incentrato sullo sviluppatore

ArjunaCRM genera API specificamente per il tuo modello di dati, significando:
...
ArjunaCRM offre API sia in formati **REST** che **GraphQL**:
