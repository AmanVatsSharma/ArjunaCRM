...
info: Disse arbeidsflytene fokuserer på å føre data inn og ut av ArjunaCRM gjennom API-kall og webhooks.
...
Nedenfor er eksempler på arbeidsflyter du kan implementere for å koble ArjunaCRM til resten av systemet ditt.

## Data Ingestion Use Cases

### Webform Submissions

**Problem**: Du trenger å fange opp leads fra nettskjemaer, landingssider eller kontaktskjemaer direkte inn i ArjunaCRM.
...
**Løsning**: Synkroniser produktdata regelmessig inn i ArjunaCRM for å gi selgere kontekst om sine kontoer.
...
**Oppsett**: Opprett en visning i ArjunaCRM med alle nyhetsbrevmottakere
...
**Problem**: Du må holde data synkronisert mellom ArjunaCRM og et annet system i begge retninger.
...
**Problem**: Data fra eksterne kilder trenger kompleks behandling før de kan brukes i ArjunaCRM.
