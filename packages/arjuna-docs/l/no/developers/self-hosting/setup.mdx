...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/no/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

ArjunaCRM tilbyr **to konfigurasjonsmoduser** for å passe forskjellige distribusjonsbehov:
...
1. Tilgang til din ArjunaCRM instans (vanligvis `http://localhost:3000`)
...
<Warning>
Brukere må ha en [Microsoft 365 Lisens](https://admin.microsoft.com/Adminportal/Home) for å kunne bruke Kalender og Meldings API. De vil ikke kunne synkronisere sin konto på ArjunaCRM uten en.
</Warning>
