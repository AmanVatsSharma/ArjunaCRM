...
info: Lær hvordan du kan samarbeide med ArjunaCRM's Figma
...
1. **Få tilgang til den delte lenken:** Du kan få tilgang til prosjektets Figma-fil [her](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/ArjunaCRM).
...
På venstre sidefelt kan du få tilgang til de forskjellige sidene av ArjunaCRM's Figma. Slik er de organisert:
