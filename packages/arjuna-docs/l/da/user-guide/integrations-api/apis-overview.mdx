...
sectionInfo: Lær hvordan du forbinder ArjunaCRM til dine andre værktøjer.
---
...
ArjunaCRM blev bygget til at være udviklervenlig, med kraftfulde API'er der tilpasses din brugerdefinerede datamodel. Vi leverer fire forskellige API-typer til at imødekomme forskellige integrationsbehov.

## Udvikler-første tilgang

ArjunaCRM genererer API'er specielt til din datamodel, hvilket betyder:
...
ArjunaCRM tilbyder API'er i både **REST** og **GraphQL** formater:
