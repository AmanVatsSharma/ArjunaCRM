...
Quan comences a utilitzar ArjunaCRM, voldràs introduir els teus contactes i empreses al sistema. Hi ha diverses maneres d'omplir el teu CRM segons el teu flux de treball i les teves fonts de dades.

### Entrada manual

L'enfocament més directe és afegir registres directament a través de la interfície de ArjunaCRM. Ves a la secció `Persones` i fes clic al botó `+` per afegir un nou contacte. Omple el seu nom, correu electrònic, telèfon, i vincula'ls a la seva empresa. Per a empreses, dirigueix-te a la secció `Empreses` i afegeix els detalls de l'organització: nom de l'empresa, domini, indústria i mida.
...
Per a la generació contínua de clients potencials, pots configurar fluxos de treball automatitzats que portin dades directament a ArjunaCRM:

**Formularis web**: Quan algú omple un formulari al teu lloc web, pots configurar-lo per enviar la informació a ArjunaCRM automàticament. L'enviament del formulari activa un webhook que engega un flux de treball a ArjunaCRM, creant el nou registre de contacte sense treball manual.

**Integració amb altres sistemes**: Si utilitzes altres eines de negocis, pots connectar-les a ArjunaCRM utilitzant API i fluxos de treball. Això et permet sincronitzar dades automàticament entre sistemes: per exemple, portant nous clients del teu sistema de facturació o clients potencials de la teva plataforma de màrqueting.
...
Quan connectes la teva bústia de correu i el calendari a ArjunaCRM, el sistema pot crear automàticament registres de Persones i Empreses per a les persones amb qui envies correus electrònics o et reuneixes. Si envies un correu electrònic a algú que encara no està al teu CRM, ArjunaCRM pot crear un nou registre per a aquesta persona. El mateix passa quan programes reunions amb nous contactes a través del teu calendari.

Això és especialment útil per a equips de vendes i desenvolupament empresarial que estan constantment reunint-se amb noves persones. En lloc d'afegir manualment cada nou contacte, ArjunaCRM els captura automàticament a mesura que et comuniques. Aprèn a configurar això a la nostra guia de [Correus electrònics i Calendaris](/l/ca/user-guide/collaboration/emails-and-calendars).
...
A vegades t'acabaràs trobant amb registres duplicats. ArjunaCRM té una funció de fusió per a Persones i Empreses: pots combinar registres duplicats per mantenir la teva base de dades neta sense perdre informació.
...
Quan suprimeixes un registre a ArjunaCRM, no desapareix per sempre. Els registres es "suprimeixen de manera suau", el que significa que estan amagats però es poden restaurar si cal.
