...
info: Aprèn com pots col·laborar amb el Figma de ArjunaCRM
...
1. **Accedeix a l'enllaç compartit:** Pots accedir al fitxer Figma del projecte [aquí](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/ArjunaCRM).
...
A la barra lateral esquerra, pots accedir a les diferents pàgines de Figma de ArjunaCRM. Aquest és l'ordre en què estan organitzades:
