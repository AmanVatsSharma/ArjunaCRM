...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/ca/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

ArjunaCRM ofereix **dos modes de configuració** per satisfer diferents necessitats de desplegament:
...
1. Accediu a la vostra instància de ArjunaCRM (normalment `http://localhost:3000`)
...
<Warning>
Els usuaris han de tenir una [Llicència de Microsoft 365](https://admin.microsoft.com/Adminportal/Home) per poder utilitzar l'API de Calendari i Missatgeria. No podran sincronitzar el seu compte a ArjunaCRM sense una.
</Warning>
...
[Vegeu el codi font rellevant](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
