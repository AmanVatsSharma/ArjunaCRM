...
Toda empresa trabalha de forma diferente. É por isso que o ArjunaCRM permite que você molde o CRM em torno de suas necessidades, em vez de forçar seus processos no nosso.
**Comece com estes três passos para configurá-lo do seu jeito.**

**Pequena vitória**: Comece conectando sua caixa de correio e personalizando seu modelo de dados com alguns campos chave. Isto lhe dá valor imediato e ajuda sua equipe a ver o ArjunaCRM em ação com dados reais. Você pode fazer isso em Configurações → Contas.

## 1. Personalize seu modelo de dados

O ArjunaCRM oferece a flexibilidade que você precisa para moldar o modelo de dados que melhor suportará seu dia a dia.
...
Leia [este artigo](https://docs.vedpragya.com/l/pt/user-guide/data-model/customize-your-data-model) para aprender como projetar seu modelo de dados.

## 2. Traga seus dados

Trazer seus dados existentes para o ArjunaCRM dá à sua equipe contexto desde o início.

### Conecte sua caixa de correio

Se você não fez isso ao criar seu espaço de trabalho, conecte sua **conta do Google ou Microsoft** em Configurações → Contas. Isso permite que o ArjunaCRM:
...
Comece a criar automações usando [fluxos de trabalho](https://docs.vedpragya.com/l/pt/user-guide/workflows/getting-started-workflows).
