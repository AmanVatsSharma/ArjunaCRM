...
sectionInfo: Aprenda como conectar o ArjunaCRM às suas outras ferramentas.
---
...
A ArjunaCRM foi construída para ser amigável aos desenvolvedores, oferecendo APIs poderosas que se adaptam ao seu modelo de dados personalizado. Oferecemos quatro tipos distintos de API para atender a diferentes necessidades de integração.

## Abordagem Focada no Desenvolvedor

A ArjunaCRM gera APIs especificamente para o seu modelo de dados, ou seja:
...
A ArjunaCRM oferece APIs nos formatos **REST** e **GraphQL**:
