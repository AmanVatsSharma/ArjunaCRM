...
info: Esses fluxos de trabalho focam em trazer dados para dentro e para fora do ArjunaCRM através de chamadas de API e webhooks.
...
Abaixo estão exemplos de fluxos de trabalho que você poderia implementar para conectar o ArjunaCRM com o restante do seu stack.

## Casos de Uso de Ingestão de Dados

### Envio de Formulários Web

**Problema**: Você precisa capturar leads de formulários do site, landing pages ou formulários de contato diretamente no ArjunaCRM.
...
**Solução**: Sincronize regularmente os dados do produto no ArjunaCRM para fornecer aos vendedores contexto sobre suas contas.
...
**Configuração**: Crie uma visualização no ArjunaCRM com todos os destinatários da newsletter
...
**Problema**: Você precisa manter os dados sincronizados entre o ArjunaCRM e outro sistema em ambas as direções.

**Solução**: Combine fluxos de trabalho agendados com gatilhos de webhook para sincronização em tempo real.

**De ArjunaCRM para Sistema Externo**:
...
**De Sistema Externo para ArjunaCRM**:
...
**Problema**: Dados de fontes externas precisam de processamento complexo antes de serem usados no ArjunaCRM.
