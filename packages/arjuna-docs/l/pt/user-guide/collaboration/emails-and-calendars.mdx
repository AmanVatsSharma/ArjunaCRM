...
O ArjunaCRM vincula automaticamente os emails de suas caixas de correio conectadas aos registros de CRM relevantes, mantendo todo o histórico de comunicação em um só lugar.
...
Controle quais pastas de email serão sincronizadas com o ArjunaCRM:
...
- **Emails Ausentes**: Verifique se:
  ...
  - A criação automática de contato está desativada (emails precisam de registros ArjunaCRM existentes)
