...
| conteúdo         | Nome opcional para estilização adicional     | O conteúdo que deseja exibir na dica                                                                                                                                                                                                    |
...
| Props | Tipo                                     | Descrição                                                                     |
| ----- | ---------------------------------------- | ----------------------------------------------------------------------------- |
| texto | Nome opcional para estilização adicional | O conteúdo que você deseja exibir na área de texto excessivo. |
