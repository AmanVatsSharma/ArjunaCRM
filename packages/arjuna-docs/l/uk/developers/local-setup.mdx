...
description: "Посібник для учасників проекту (або цікавих розробників), які хочуть запустити ArjunaCRM локально."
...
Перед інсталяцією та використанням ArjunaCRM переконайтеся, що встановлено наступне на вашому комп'ютері:
...
ArjunaCRM вимагає кешу redis для забезпечення найкращої продуктивності
...
Use environment variables or `.env` files to configure your project. Більше інформації [тут](https://docs.vedpragya.com/l/uk/developers/self-hosting/setup)
...
Щоб побудувати сервер ArjunaCRM і додати деякі дані в вашу базу даних, виконайте наступну команду:
...
## Крок 8: Використання ArjunaCRM

**Frontend**

Frontend ArjunaCRM працюватиме на [http://localhost:3001](http://localhost:3001).
Ви можете увійти, використовуючи стандартний демо-акаунт: `tim@apple.dev` (пароль: `tim@apple.dev`)

**Backend**

- Сервер ArjunaCRM буде запущений на [http://localhost:3000](http://localhost:3000)
...
Якщо виникнуть проблеми, перегляньте [Усунення несправностей](https://docs.vedpragya.com/l/uk/developers/self-hosting/troubleshooting) для отримання вирішення.