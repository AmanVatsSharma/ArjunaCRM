...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/uk/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

ArjunaCRM пропонує **два режими конфігурації**, щоб задовольнити різні потреби розгортання:
...
1. Отримайте доступ до свого ArjunaCRM-екземпляру (зазвичай `http://localhost:3000`)
...
[Див. відповідний вихідний код](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
Користувачі повинні мати [ліцензію Microsoft 365](https://admin.microsoft.com/Adminportal/Home), щоб мати змогу використовувати API Календаря та Повідомлень. Вони не зможуть синхронізувати свій обліковий запис у ArjunaCRM без неї.
</Warning>
...
[Див. відповідний вихідний код](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
