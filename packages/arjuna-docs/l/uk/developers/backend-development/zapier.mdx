...
Легко синхронізуйте ArjunaCRM з 3000+ додатками за допомогою [Zapier](https://zapier.com/). Автоматизуйте завдання, підвищуйте продуктивність і зміцнюйте відносини з клієнтами!
...
З папки `packages/arjuna-zapier` виконайте команду:
