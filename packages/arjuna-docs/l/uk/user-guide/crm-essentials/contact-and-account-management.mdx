...
Почавши використовувати ArjunaCRM, ви захочете додати контакти та компанії у систему. There are several ways to populate your CRM depending on your workflow and data sources.

### Введення вручну

Найпростіший підхід — додавати записи безпосередньо через інтерфейс ArjunaCRM. Перейдіть до розділу `Люди` та натисніть кнопку `+`, щоб додати новий контакт. Заповніть їхнє ім'я, електронну адресу, телефон та зв’яжіть їх із компанією. Для компаній перейдіть до розділу `Компанії` та додайте деталі організації: назва компанії, домен, галузь та розмір.
...
**Integration with other systems**: If you use other business tools, you can connect them to ArjunaCRM using API calls and workflows. Це дозволяє автоматично синхронізувати дані між системами: наприклад, додаючи нових клієнтів із вашої системи білінгу або ліди з вашої маркетингової платформи.
...
ArjunaCRM automatically enforces uniqueness to keep your data organized. Електронна адреса кожної особи слугує унікальним ідентифікатором: ви не можете мати двох людей з тією ж електронною адресою. Similarly, company domains are unique, so you won't accidentally create duplicate companies.
...
Коли ви видаляєте запис у ArjunaCRM, він не зникає назавжди. Записи «м'яко видаляються», тобто вони приховані, але можуть бути відновлені за необхідності.
