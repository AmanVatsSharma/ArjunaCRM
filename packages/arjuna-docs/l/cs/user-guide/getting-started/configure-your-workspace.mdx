...
info: "Začněte konfigurovat svůj pracovní prostor pomocí těchto tří kroků."
image: /images/user-guide/what-is-arjuna/getting_started.png
sectionInfo: Objevte ArjunaCRM, open-source CRM.
---

<Frame>
  <img src="/images/user-guide/what-is-arjuna/getting_started.png" alt="Header" />
</Frame>

Každý podnik funguje odlišně. That's why ArjunaCRM lets you shape the CRM around your needs, not force your processes into ours.
**Začněte těmito třemi kroky, abyste to nastavili podle svého.**

**Rychlé vítězství**: Začněte připojením své e-mailové schránky a přizpůsobením svého datového modelu několika klíčovými poli. To vám dává okamžitou hodnotu a pomáhá vašemu týmu vidět ArjunaCRM v akci s reálnými daty. Můžete to udělat v Nastavení → Účty.

## 1. Přizpůsobte si svůj datový model

ArjunaCRM nabízí flexibilitu, kterou potřebujete pro tvarování datového modelu, který nejlépe podpoří vaši každodenní práci.
...
- **Lidé, Společnosti a Příležitosti jsou tři objekty, ze kterých můžete přistupovat k e-mailům a schůzkám synchronizovaným ze své poštovní schránky/kalendáře**. Doporučujeme je používat co nejvíce, přidávat pole pro kategorizaci svých záznamů, pokud je potřeba. Zde je příklad:
...
Přečtěte si [tento článek](https://docs.vedpragya.com/l/cs/user-guide/data-model/customize-your-data-model), kde se dozvíte, jak navrhnout svůj datový model.

## 2. Přeneste svá data

Přinesení vašich stávajících dat do ArjunaCRM dává vašemu týmu od začátku kontext.

### Připojte svou e-mailovou schránku

Pokud jste tak neučinili při vytváření svého pracovního prostoru, připojte svůj **Google nebo Microsoft účet** v Nastavení → Účty. To umožňuje ArjunaCRM:
...
Přečtěte si [tento článek](/l/cs/user-guide/getting-started/import-export-data), kde se dozvíte více o importu dat.
...
Začněte vytvářet automatizace pomocí [workflow](https://docs.vedpragya.com/l/cs/user-guide/workflows/getting-started-workflows).
