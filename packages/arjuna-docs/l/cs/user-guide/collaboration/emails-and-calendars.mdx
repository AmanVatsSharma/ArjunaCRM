...
ArjunaCRM automaticky propojuje emaily z vašich připojených schránek s příslušnými CRM záznamy, udržuje historii komunikace na jednom místě.
...
Ovládejte, které emailové složky se synchronizují s ArjunaCRM:
...
- **Chybějící emaily**: Zkontrolujte, zda:
  ...
  - Automatické vytváření kontaktů je deaktivováno (emaily potřebují existující záznamy ArjunaCRM)
