...
4. Autorizujte ArjunaCRM pro přístup k vašemu Gmailu a Google Kalendáři
...
4. Autorizujte ArjunaCRM pro přístup k vašemu Outlooku a Microsoft Kalendáři
5. Your emails and calendar events will start syncing automatically
...
<Warning>
Pouze skutečné schránky mohou být připojeny (např. podpora@domena.com s vlastní schránkou). Emailové aliasy, které přeposílají do jiné schránky, nemohou být připojeny do ArjunaCRM.
</Warning>
...
Řízení, které složky emailu se synchronizují s ArjunaCRM:
...
**Poznámka**: Neposkytujeme CC emailovou adresu pro selektivní synchronizaci. Místo toho použijte výše uvedenou funkci Složka Zpráv pro dosažení stejné úrovně kontroly nad tím, které emaily se synchronizují s ArjunaCRM.
