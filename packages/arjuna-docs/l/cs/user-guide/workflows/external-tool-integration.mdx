...
info: Tyto pracovní postupy se zaměřují na přenos dat dovnitř a ven z ArjunaCRM pomocí API volání a webhooků.
...
Níže jsou příklady pracovních postupů, které můžete zavést pro propojení ArjunaCRM s ostatním vaším systémem.

## Případy Použití Příjmu Dat

### Submise Webového Formuláře

**Problém**: Potřebujete zachytit potenciální zákazníky z webových formulářů, vstupních stránek nebo kontaktních formulářů přímo do ArjunaCRM.
...
**Řešení**: Pravidelně synchronizujte data produktů do ArjunaCRM, abyste prodejcům poskytli kontext o jejich účtech.
...
**Nastavení**: Vytvořte zobrazení ve ArjunaCRM se všemi příjemci newsletterů
...
**Problém**: Potřebujete udržovat data synchronizovaná mezi ArjunaCRM a jiným systémem v obou směrech.

**Solution**: Combine scheduled workflows with webhook triggers for real-time sync.

**Z ArjunaCRM do externího systému**:
...
**Z externího systému do ArjunaCRM**:
...
**Problém**: Data z externích zdrojů potřebují komplexní zpracování před jejich použitím ve ArjunaCRM.
