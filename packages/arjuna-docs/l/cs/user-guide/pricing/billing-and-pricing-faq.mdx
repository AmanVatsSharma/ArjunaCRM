...
sectionInfo: Pochopte, jak funguje cenový model ArjunaCRM.
---
...
Ano, můžete používat ArjunaCRM zdarma při vlastním hostingu. Budete mít přístup ke všem funkcím zahrnutým v (cloudovém) Pro předplatném, kromě podpory od našeho hlavního týmu. Podpora je dostupná prostřednictvím naší komunity na Discordu.
...
We do not offer free seats. Cena je stanovena za uživatele a každý uživatel potřebuje licenci pro přístup k ArjunaCRM.
</Accordion>
