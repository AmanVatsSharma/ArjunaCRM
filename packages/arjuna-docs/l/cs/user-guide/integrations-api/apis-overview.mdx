...
sectionInfo: Naučte se, jak připojit ArjunaCRM k vašim dalším nástrojům.
---
...
ArjunaCRM bylo vytvořeno s ohledem na vývojáře, nabízíme výkonné API, které se přizpůsobí vašemu vlastnímu datovému modelu. Nabízíme čtyři typy API, které splňují různé potřeby integrace.

## Přístup orientovaný na vývojáře

ArjunaCRM generuje API specificky pro váš datový model, což znamená:
...
ArjunaCRM nabízí API v obou formátech **REST** a **GraphQL**:
