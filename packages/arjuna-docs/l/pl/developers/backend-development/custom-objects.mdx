...
Obiekty to struktury, które umożliwiają przechowywanie danych (rekordów, atrybutów i wartości) specyficznych dla organizacji. ArjunaCRM udostępnia zarówno obiekty standardowe, jak i niestandardowe.

Obiekty standardowe to wbudowane obiekty z zestawem atrybutów dostępnych dla wszystkich użytkowników. Przykłady obiektów standardowych w ArjunaCRM to Firma i Osoba. Obiekty standardowe mają standardowe pola, które są dostępne dla wszystkich użytkowników ArjunaCRM, takie jak Company.displayName.
