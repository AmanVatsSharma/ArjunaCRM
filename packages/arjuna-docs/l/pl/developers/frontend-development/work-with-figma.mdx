...
1. **Uzyskaj dostęp do udostępnionego linku:** Możesz uzyskać dostęp do pliku projektu Figma [tutaj](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/ArjunaCRM).
...
On the left sidebar, you can access the different pages of ArjunaCRM's Figma. Oto, jak są zorganizowane:
