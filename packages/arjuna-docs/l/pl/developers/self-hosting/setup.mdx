...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/pl/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

ArjunaCRM oferuje **dwa tryby konfiguracji**, aby odpowiadać na różne potrzeby wdrożenia:
...
1. Access your ArjunaCRM instance (usually `http://localhost:3000`)
...
[Zobacz odpowiedni kod źródłowy](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
Użytkownicy muszą mieć [licencję Microsoft 365](https://admin.microsoft.com/Adminportal/Home), aby móc korzystać z API Kalendarza i Wiadomości. Nie będą mogli zsynchronizować swojego konta na ArjunaCRM bez niej.
</Warning>
...
[Zobacz odpowiedni kod źródłowy](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
