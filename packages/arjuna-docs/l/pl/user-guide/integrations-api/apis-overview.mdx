...
sectionInfo: Dowiedz się, jak połączyć ArjunaCRM z innymi narzędziami.
---
...
ArjunaCRM zostało stworzone jako przyjazne dla deweloperów, oferując potężne API, które dostosowują się do Twojego niestandardowego modelu danych. Oferujemy cztery różne typy API, aby sprostać różnorodnym potrzebom integracyjnym.

## Podejście zorientowane na dewelopera

ArjunaCRM generuje API specjalnie dla Twojego modelu danych, co oznacza:
...
ArjunaCRM oferuje API w formatach **REST** i **GraphQL**:
