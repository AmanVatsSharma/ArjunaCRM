...
info: Te przepływy pracy skupiają się na wprowadzaniu i wyprowadzaniu danych do i z ArjunaCRM za pośrednictwem wywołań API i webhooków.
...
Poniżej znajdują się przykłady przepływów pracy, które możesz wdrożyć, aby połączyć ArjunaCRM z resztą twojego stosu.
...
**Konfiguracja**: Utwórz widok w ArjunaCRM z wszystkimi odbiorcami newslettera
...
**Problem**: Musisz synchronizować dane między ArjunaCRM a innym systemem w obu kierunkach.

**Rozwiązanie**: Połącz planowane przepływy pracy z wyzwalaczami webhook dla synchronizacji w czasie rzeczywistym.

**Z ArjunaCRM do systemu zewnętrznego**:
...
**Z systemu zewnętrznego do ArjunaCRM**:
...
**Problem**: Dane z zewnętrznych źródeł wymagają złożonego przetworzenia zanim mogą być użyte w ArjunaCRM.
