...
ArjunaCRM automatycznie łączy e-maile z Twoich skrzynek pocztowych z odpowiednimi zapisami CRM, utrzymując całą historię komunikacji w jednym miejscu.
...
Kontroluj, które foldery e-mail synchronizują się z ArjunaCRM:
...
- **Brakujące e-maile**: Sprawdź, czy:
  ...
  - Automatyczne tworzenie kontaktów jest wyłączone (e-maile wymagają istniejących zapisów ArjunaCRM)
