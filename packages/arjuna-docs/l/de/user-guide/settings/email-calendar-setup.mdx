...
info: "Verbinden Sie Ihre E-Mail- und Kalenderkonten."
...
4. Authorize ArjunaCRM to access your Gmail and Google Calendar
5. Ihre E-Mails und Kalendereinträge werden automatisch synchronisiert
...
4. Authorize ArjunaCRM to access your Outlook and Microsoft Calendar
5. Ihre E-Mails und Kalendereinträge werden automatisch synchronisiert
...
<Warning>
Es können nur echte Postfächer verbunden werden (z.B. support@domain.com mit eigenem Posteingang). E-Mail-Aliase, die zu einem anderen Postfach weiterleiten, können nicht mit ArjunaCRM verbunden werden.
</Warning>
...
Bestimmen Sie, welche E-Mail-Ordner mit ArjunaCRM synchronisiert werden:
...
**Hinweis**: Wir bieten keine CC-E-Mail-Adresse für selektives Synchronisieren an. Verwenden Sie stattdessen die oben genannte Nachrichtenordner-Funktion, um dieselbe Kontrolle darüber zu erhalten, welche E-Mails mit ArjunaCRM synchronisiert werden.
