...
info: Diese Arbeitsabläufe konzentrieren sich darauf, Daten über API-Aufrufe und Webhooks in ArjunaCRM zu bringen und herauszubringen.
...
Below are workflow examples you could roll out to connect ArjunaCRM with the rest of your stack.

## Anwendungsfälle für die Datenaufnahme

### Webformular-Einsendungen

**Problem**: Sie müssen Leads aus Website-Formularen, Zielseiten oder Kontaktformularen direkt in ArjunaCRM erfassen.
...
**Lösung**: Regelmäßig Produktdaten in ArjunaCRM synchronisieren, um Verkäufern Kontext über ihre Konten zu geben.
...
**Setup**: Create a view in ArjunaCRM with all newsletter recipients
...
**Problem**: Sie müssen Daten zwischen ArjunaCRM und einem anderen System in beide Richtungen synchronisieren.

**Lösung**: Kombinieren Sie geplante Workflows mit Webhook-Auslösern für Echtzeit-Synchronisation.

**Von ArjunaCRM zum externen System**:
...
**Vom externen System zu ArjunaCRM**:
...
**Problem**: Daten aus externen Quellen benötigen eine komplexe Verarbeitung, bevor sie in ArjunaCRM verwendet werden können.
