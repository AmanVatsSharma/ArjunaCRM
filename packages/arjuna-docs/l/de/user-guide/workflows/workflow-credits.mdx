...
info: Verstehen Sie den Verbrauch, die Überwachung und das Kostenmanagement von Workflow-Guthaben für Ihre Automatisierungen.
...
Workflow-Guthaben treiben Ihre Automatisierungen in ArjunaCRM an. Das Verständnis ihrer Funktionsweise hilft Ihnen, die Kosten zu optimieren und Ihr Automatisierungsbudget effektiv zu verwalten.
...
- **Optimierung manueller Auslöser**: Für manuelle Auslöser wählen Sie die Verfügbarkeit "Massenverarbeitung", um mehrere Datensätze in einem Workflowdurchlauf zu verarbeiten (Einzelheiten finden Sie unter [Workflow-Funktionen](/l/de/user-guide/workflows/workflow-features))
...
Für detaillierte Abrechnungsinformationen und Guthabenverwaltung besuchen Sie **Einstellungen → Abrechnung** in Ihrem ArjunaCRM-Workspace.
