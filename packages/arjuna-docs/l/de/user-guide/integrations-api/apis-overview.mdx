...
sectionInfo: Erfahren Sie, wie Sie ArjunaCRM mit Ihren anderen Tools verbinden.
---
...
ArjunaCRM wurde so entwickelt, dass es entwicklerfreundlich ist und leistungsstarke APIs bietet, die sich an Ihr individuelles Datenmodell anpassen. Wir bieten vier verschiedene API-Typen, um unterschiedlichen Integrationsanforderungen gerecht zu werden.

## Entwickler-Erst-Ansatz

ArjunaCRM generiert speziell für Ihr Datenmodell APIs, das bedeutet:
...
ArjunaCRM bietet APIs in den Formaten **REST** und **GraphQL** an:
