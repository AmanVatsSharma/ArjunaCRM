---
title: Getting around ArjunaCRM
...
image: /images/user-guide/what-is-arjuna/getting_around.png
sectionInfo: Entdecken Sie ArjunaCRM, ein Open-Source-CRM.
---

<Frame>
  <img src="/images/user-guide/what-is-arjuna/getting_around.png" alt="Header" />
</Frame>

Wenn Sie sich das erste Mal bei ArjunaCRM anmelden, sollte das Layout intuitiv wirken. Es ist darauf ausgelegt, dass Sie schnell arbeiten und organisiert bleiben können, ohne dass es sich störend auf Ihr Arbeiten auswirkt.
...
Das Befehlsmenü gibt Ihnen **schnellen Zugriff auf Aktionen und Suche** in ArjunaCRM. Sie können es auf zwei Weisen aufrufen:
...
- Auf gelöschte Datensätze zugreifen (ArjunaCRM unterstützt weiches und hartes Löschen)
