...
Objects are structures that allow you to store data (records, attributes, and values) specific to an organization. ArjunaCRM provides both standard and custom objects.

Vakiomuotoiset objektit ovat sisäänrakennettuja objekteja, joissa on joukko attribuutteja kaikille käyttäjille. Examples of standard objects in ArjunaCRM include Company and Person. Standard objects have standard fields that are also available for all ArjunaCRM users, like Company.displayName.
