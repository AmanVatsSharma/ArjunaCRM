...
Synkronoi ArjunaCRM vaivattomasti yli 3000 sovelluksen kanssa käyttäen [Zapier](https://zapier.com/). Automatisoi tehtäviä, lisää tuottavuutta ja tehosta asiakassuhteitasi!
...
Suorita `packages/arjuna-zapier`-kansiosta:
