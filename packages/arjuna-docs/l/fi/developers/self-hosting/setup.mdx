...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/fi/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

ArjunaCRM tarjoaa **kaksi konfiguraatiotapaa** eri käyttöönoton tarpeisiin:
...
1. Avaa ArjunaCRM-instanssisi (yleensä `http://localhost:3000`)
...
[Katso olennainen lähdekoodi](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
Users must have a [Microsoft 365 Licence](https://admin.microsoft.com/Adminportal/Home) to be able to use the Calendar and Messaging API. He eivät pysty synkronoimaan tiliään ArjunaCRMssä ilman lisenssiä.
</Warning>
...
[Katso olennainen lähdekoodi](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
