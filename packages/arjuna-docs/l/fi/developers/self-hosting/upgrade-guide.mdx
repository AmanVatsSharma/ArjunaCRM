...
1. Päätelaitteessa, jossa ArjunaCRM on käynnissä, sammuta ArjunaCRM: `docker compose down`
...
3. Käynnistä ArjunaCRM uudelleen käyttämällä `docker compose up -d`
...
Tervetuloa ArjunaCRM versioon v1.0! 🎉
...
Jos kohtaat suoritusongelmia päivityksen jälkeen, saatat joutua tyhjentämään välimuistisi varmistaaksesi sen synkronoinnin uusimpien muutosten kanssa. Suorita tämä komento arjuna-server-säilössäsi:
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.55-kuvaa
...
Suorita seuraava komento `arjuna-server`-säilössäsi:

```bash
yarn command:prod cache:flush
```

Tämä ongelma koskee vain tätä ArjunaCRM-versiota eikä pitäisi olla tarpeen jatkossa.
...
Sen tulisi aina olla nykyisen ArjunaCRMn asennusversion `major.minor`-välillä, voit tarkistaa asennusversion hallintapaneelista (osoitteessa `/settings/admin-panel`, saavutettavissa jos käyttäjälläsi on `canAccessFullAdminPanel`-omaisuus määritetty arvoksi true tietokannassa) tai suorittamalla komento `echo $APP_VERSION` `arjuna-server`-säilössäsi.

Voit ratkaista epäyhtenäisen työtilan version päivittämällä vastaavasta ArjunaCRMn versiosta liittyvän päivitysoppaan ohjeiden mukaisesti vaiheittain, kunnes saavutat toivotun version.
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.52-kuvaa
...
Sinun on päivitettävä työtilan versioksi `0.51.0` tietokantaan käsin ja päivitettävä ArjunaCRM-versiolla `0.52.11` seuraamalla sen yläpuolella annettua päivitysopasta.

### v0.50:stä v0.51:een

Päivitä ArjunaCRM-asennuksesi käyttämään v0.51-kuvaa
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.50.0-kuvaa
...
Päivitä paikallinen `docker-compose.yml` [v0.50.0 docker-compose.yml](https://github.com/vedpragyabharat/arjuna/blob/v0.50.0/packages/arjuna-docker/docker-compose.yml) avulla

### v0.43.0:sta v0.44.0:aan

Päivitä ArjunaCRM-asennuksesi käyttämään v0.44.0-kuvaa
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.43.0-kuvaa
...
2. Päivitä docker-compose.yml käyttämään postgres:16-kuvaa, kuten [docker-compose.yml](https://raw.githubusercontent.com/vedpragyabharat/arjuna/main/packages/arjuna-docker/docker-compose.yml) -tiedostossa on.
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.42.0-kuvaa
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.41.0-kuvaa
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.40.0-kuvaa
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.35.0-kuvaa
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.34.0-kuvaa
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.33.0-kuvaa
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.32.0-kuvaa
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.31.0-kuvaa
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.30.0-kuvaa

**Breaking change**:
To enhance performances, ArjunaCRM now requires redis cache to be configured. Olemme päivittäneet [docker-compose.yml](https://raw.githubusercontent.com/vedpragyabharat/arjuna/main/packages/arjuna-docker/docker-compose.yml) heijastamaan tätä.
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.24.0-kuvaa
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.23.0-kuvaa
...
Päivitä ArjunaCRM-asennuksesi käyttämään v0.22.0-kuvaa
