...
ArjunaCRM on suunniteltu kehittäjäystävälliseksi, tarjoten tehokkaita APIa, jotka mukautuvat mukautettuun tietomalliisi. Tarjoamme neljä erilaista API-tyyppiä erilaisten integrointitarpeiden täyttämiseksi.

## Kehittäjäkeskeinen lähestymistapa

ArjunaCRM luo APIa erityisesti datamallillesi, mikä tarkoittaa:
...
ArjunaCRM tarjoaa APIa sekä **REST** että **GraphQL** muodoissa:
