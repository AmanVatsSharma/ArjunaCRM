...
description: "Ο οδηγός για συμμετέχοντες (ή περίεργους προγραμματιστές) που θέλουν να τρέξουν το ArjunaCRM τοπικά."
...
Πριν μπορέσετε να εγκαταστήσετε και να χρησιμοποιήσετε το ArjunaCRM, βεβαιωθείτε ότι έχετε εγκαταστήσει τα ακόλουθα στον υπολογιστή σας:
...
Το ArjunaCRM απαιτεί μια αναδιαταγμένη cache για την καλύτερη απόδοση
...
Χρησιμοποιήστε περιβαλλοντικές μεταβλητές ή αρχεία `.env` για να διαμορφώσετε το έργο σας. Περισσότερες πληροφορίες [εδώ](https://docs.vedpragya.com/l/el/developers/self-hosting/setup)
...
Για να κατασκευάσετε τον server του ArjunaCRM και να εισάγετε κάποια δεδομένα στη βάση δεδομένων σας, εκτελέστε την ακόλουθη εντολή:
...
## Βήμα 8: Χρήση του ArjunaCRM

**Frontend**

Το frontend του ArjunaCRM θα τρέχει στη διεύθυνση [http://localhost:3001](http://localhost:3001).
...
- Ο διακομιστής του ArjunaCRM θα λειτουργεί στη διεύθυνση [http://localhost:3000](http://localhost:3000)
