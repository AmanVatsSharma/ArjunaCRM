...
1. Στη γραμμή εντολών, στην υποδοχή όπου τρέχει το ArjunaCRM, απενεργοποιήστε το ArjunaCRM: `docker compose down`
...
3. Επαναφέρετε το ArjunaCRM στο διαδίκτυο με `docker compose up -d`
...
Εάν αντιμετωπίσετε προβλήματα χρόνου εκτέλεσης μετά την αναβάθμιση, ίσως χρειαστεί να αδειάσετε την cache σας για να βεβαιωθείτε ότι είναι συγχρονισμένη με τις τελευταίες αλλαγές. Τρέξτε αυτή την εντολή στο container του arjuna-server:
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.55
...
Στο container του `arjuna-server`, τρέξτε:

```bash
yarn command:prod cache:flush
```

Αυτό το πρόβλημα είναι συγκεκριμένο για αυτή την έκδοση του ArjunaCRM και δεν θα είναι απαραίτητο για μελλοντικές αναβαθμίσεις.
...
It should always be in the range of your current ArjunaCRM's instance `major.minor` version, you can view your instance version in the admin panel (at `/settings/admin-panel`, accessible if your user has `canAccessFullAdminPanel` property set to true in the database) or by running `echo $APP_VERSION` in your `arjuna-server` container.

Για να διορθώσετε μια αποσυνδεδεμένη έκδοση χώρου εργασίας, θα πρέπει να αναβαθμίσετε από τη σχετική έκδοση του arjuna ακολουθώντας τον σχετικό οδηγό αναβάθμισης διαδοχικά και ούτω καθεξής μέχρι να φτάσετε στην επιθυμητή έκδοση.
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.52
...
Θα χρειαστεί να ενημερώσετε χειροκίνητα την έκδοση του χώρου εργασίας σας σε `0.51.0` στη βάση δεδομένων και να αναβαθμίσετε χρησιμοποιώντας την έκδοση arjuna `0.52.11` ακολουθώντας τη σχετική καθοδήγηση αναβάθμισης.

### v0.50 σε v0.51

Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.51
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.50.0
...
Ενημερώστε το τοπικό σας `docker-compose.yml` με την [έκδοση v0.50.0 docker-compose.yml](https://github.com/vedpragyabharat/arjuna/blob/v0.50.0/packages/arjuna-docker/docker-compose.yml)

### v0.43.0 σε v0.44.0

Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.44.0
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.43.0
...
2. Αναβαθμίστε το docker-compose.yml σας για να χρησιμοποιήστε την εικόνα postgres:16 όπως στο αρχείο [docker-compose.yml](https://raw.githubusercontent.com/vedpragyabharat/arjuna/main/packages/arjuna-docker/docker-compose.yml).
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.42.0
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.41.0
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.40.0
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.35.0
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.34.0
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.33.0
...
Από αυτήν την έκδοση, η εικόνα arjuna-postgres για τη ΒΔ αποσύρθηκε και αντί αυτής, χρησιμοποιείται η arjuna-postgres-spilo.
Αν θέλετε να συνεχίσετε να χρησιμοποιείτε την εικόνα arjuna-postgres, απλά αντικαταστήστε το `arjunacrm/arjuna-postgres:${TAG}` με το `arjunacrm /arjuna-postgres` στο docker-compose.yml.

### v0.31.0 σε v0.32.0

Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.32.0
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.31.0
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.30.0

**Breaking change**:
To enhance performances, ArjunaCRM now requires redis cache to be configured. Έχουμε ενημερώσει το [docker-compose.yml](https://raw.githubusercontent.com/vedpragyabharat/arjuna/main/packages/arjuna-docker/docker-compose.yml) για να αντικατοπτρίζει αυτό.
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.24.0
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.23.0
...
Αναβαθμίστε την εγκατάσταση του ArjunaCRM για να χρησιμοποιήσετε την εικόνα v0.22.0
