...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/el/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

Το ArjunaCRM προσφέρει **δύο λειτουργίες διαμόρφωσης** για να ανταποκριθεί στις διαφορετικές ανάγκες εγκατάστασης:
...
1. Πρόσβαση στο ArjunaCRM instance σας (συνήθως `http://localhost:3000`)
...
[See relevant source code](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
Οι χρήστες πρέπει να διαθέτουν άδεια χρήσης [Microsoft 365 License](https://admin.microsoft.com/Adminportal/Home) για να μπορούν να χρησιμοποιούν το API Ημερολογίου και Μηνυμάτων. Δεν θα μπορούν να συγχρονίσουν τον λογαριασμό στο ArjunaCRM χωρίς αυτήν.
</Warning>
...
[See relevant source code](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
