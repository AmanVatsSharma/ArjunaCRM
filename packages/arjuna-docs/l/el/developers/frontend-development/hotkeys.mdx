...
Στο `arjuna-front`, ωστόσο, μπορεί να υπάρχουν συγκρούσεις μεταξύ των ίδιων συντομεύσεων που χρησιμοποιούνται σε διαφορετικά στοιχεία, τοποθετημένα ταυτόχρονα.
