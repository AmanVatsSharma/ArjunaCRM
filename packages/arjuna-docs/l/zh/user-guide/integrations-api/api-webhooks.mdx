...
sectionInfo: 學習如何將 ArjunaCRM 連接到您的其他工具。
---
...
例如，當商機移至 "成功結束" 時，Webhooks 可以自動觸發會計系統中的發票創建。 請注意，這種類型的自動化也可以使用 ArjunaCRM 的應用內[工作流功能](/l/zh/user-guide/workflows/getting-started-workflows)實現，該功能提供基於欄位更新的內部自動化觸發器。
