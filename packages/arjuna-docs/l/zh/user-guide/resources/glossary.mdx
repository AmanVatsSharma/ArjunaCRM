...
API（應用程式介面）允許您將 ArjunaCRM 連接到其他軟體系統並建立自訂整合。
...
「工作區」通常代表一個使用 ArjunaCRM 的公司。 「工作區」通常代表一個使用 ArjunaCRM 的公司。 It holds all the records and data that you and your team members add to ArjunaCRM.  
它擁有單一的域名，通常是公司員工電子郵件地址所使用的域名。

## 工作區成員

Workspace Members are the ArjunaCRM users from your team who have access to your workspace. 他們可以被指定為記錄的所有者或被分配者。
