...
sectionInfo: 了解 ArjunaCRM 的定價如何運作。
---
...
是的，您可以在自我主機時免費使用 ArjunaCRM。 除了我們核心團隊的支援外，您將可以使用所有包含在（雲端）Pro 訂閱中的內容。 支援可透過我們的 Discord 社群獲得。 除了我們核心團隊的支援外，您將可以使用所有包含在（雲端）Pro 訂閱中的內容。 支援可透過我們的 Discord 社群獲得。
...
我們不提供免費席位。 
我們不提供免費席位。 Pricing is per user and each user needs a licence to access ArjunaCRM.
