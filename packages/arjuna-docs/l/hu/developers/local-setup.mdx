...
description: "Útmutató hozzájárulók (vagy kíváncsi fejlesztők) számára, akik helyileg szeretnék futtatni a ArjunaCRM-t."
...
Mielőtt telepítenéd és használnád a ArjunaCRM-t, győződj meg róla, hogy a következőket telepítetted a számítógépeden:
...
A ArjunaCRM redis gyorsítótárat igényel a legjobb teljesítmény érdekében
...
Használj környezeti változókat vagy `.env` fájlokat a projekt konfigurálásához. További információ [itt](https://docs.vedpragya.com/l/hu/developers/self-hosting/setup)
...
- A ArjunaCRM szervere a [http://localhost:3000](http://localhost:3000) címen lesz elérhető
