...
Ebben az útmutatóban megismerkedsz a projektkönyvtár struktúrájának részleteivel, és hogy ez hogyan járul hozzá a ArjunaCRM szervezéséhez és karbantarthatóságához.
