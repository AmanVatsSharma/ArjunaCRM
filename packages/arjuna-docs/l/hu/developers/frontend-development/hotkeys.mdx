...
A `arjuna-front` alkalmazásban azonban előfordulhat, hogy ugyanazokat a billentyűparancsokat különböző komponensek használják egy időben, ami ütközésekhez vezethet.
