...
sectionInfo: Tudja meg, hogyan kapcsolja össze a ArjunaCRM-t más eszközeivel.
---
...
A ArjunaCRM fejlesztőbarátnak lett tervezve, erőteljes API-kat kínál, amelyek alkalmazkodnak az egyedi adatmodelljéhez. Négy különálló API típust biztosítunk különböző integrációs igények kielégítésére.

## Fejlesztő-központú megközelítés

A ArjunaCRM kifejezetten az Ön adatmodelljére generál API-kat, ami azt jelenti:
...
A ArjunaCRM **REST** és **GraphQL** formátumú API-kat kínál:
