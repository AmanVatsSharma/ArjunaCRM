...
<Warning>
**First time installing?** Follow the [Docker Compose installation guide](https://docs.vedpragya.com/l/sr/developers/self-hosting/docker-compose) to get ArjunaCRM running, then return here for configuration.
</Warning>

ArjunaCRM offers **two configuration modes** to suit different deployment needs:
...
1. Приступите својој ArjunaCRM инстанци (обично `http://localhost:3000`)
...
[Погледајте релевантан изворни код](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
Корисници морају имати [Microsoft 365 лиценцу](https://admin.microsoft.com/Adminportal/Home) да би могли користити календар и API за слање порука. Неће моћи синхронизовати свој налог на ArjunaCRM без тога.
</Warning>
...
[Погледајте релевантан изворни код](https://github.com/vedpragyabharat/arjuna/blob/main/packages/arjuna-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
