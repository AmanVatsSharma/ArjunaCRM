---
title: Glosario
info: "Familiarízate con la terminología esencial utilizada en ArjunaCRM."
...
La API (Interfaz de Programación de Aplicaciones) permite conectar ArjunaCRM con otros sistemas de software y construir integraciones personalizadas.
...
Favoritos son registros que has marcado para acceso rápido, apareciendo en tu barra lateral para una navegación instantánea a datos importantes.

## Campo

Un campo se refiere a un área específica donde se almacena datos particulares para una entidad.

## Integration

Integration are built-in tools that allow to link ArjunaCRM with other software or systems.
...
Las Oportunidades en el CRM de ArjunaCRM son posibles tratos o ventas con cuentas o contactos.
...
Las Tareas en el CRM de ArjunaCRM son actividades asignadas relacionadas con contactos, cuentas u oportunidades.
...
Los Webhooks son mensajes automatizados que se envían desde ArjunaCRM a otras aplicaciones cuando ocurren eventos específicos, habilitando la sincronización de datos en tiempo real.
...
Un `Espacio de Trabajo` típicamente representa una empresa que usa ArjunaCRM. Contiene todos los registros y datos que tú y los miembros de tu equipo añaden a ArjunaCRM.  
...
Los Miembros del Espacio de Trabajo son los usuarios de ArjunaCRM de tu equipo que tienen acceso a tu espacio de trabajo. Pueden ser asignados como propietarios o asignados a registros.
