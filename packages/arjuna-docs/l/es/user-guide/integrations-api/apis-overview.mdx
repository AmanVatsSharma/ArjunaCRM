...
sectionInfo: Aprenda a conectar ArjunaCRM con sus otras herramientas.
---
...
ArjunaCRM fue creado para ser amigable con los desarrolladores, ofreciendo APIs potentes que se adaptan a tu modelo de datos personalizado. Proveemos cuatro tipos de API distintos para satisfacer diferentes necesidades de integración.

## Enfoque centrado en el desarrollador

ArjunaCRM genera APIs específicamente para tu modelo de datos, lo que significa:
...
ArjunaCRM ofrece APIs en formatos **REST** y **GraphQL**:
