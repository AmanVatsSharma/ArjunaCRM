...
ArjunaCRM vincula automáticamente los correos electrónicos de sus buzones conectados a los registros CRM relevantes, manteniendo todo el historial de comunicación en un solo lugar.
...
Controle qué carpetas de correo electrónico se sincronizan con ArjunaCRM:
...
- **Correos Faltantes**: Compruebe si:
  ...
  - La creación automática de contactos está desactivada (los correos necesitan registros existentes de ArjunaCRM)
