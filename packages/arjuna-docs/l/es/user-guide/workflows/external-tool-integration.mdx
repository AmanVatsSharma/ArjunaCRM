...
info: Estos flujos de trabajo se centran en llevar datos dentro y fuera de ArjunaCRM a través de llamadas API y webhooks.
...
A continuación, se presentan ejemplos de flujos de trabajo que podrías implementar para conectar ArjunaCRM con el resto de tu set de herramientas.

## Casos de Uso de Ingesta de Datos

### Envíos de Formularios Web

**Problema**: Necesitas capturar clientes potenciales desde formularios web, páginas de destino o formularios de contacto directamente en ArjunaCRM.
...
**Solución**: Sincroniza regularmente los datos del producto en ArjunaCRM para proporcionar contexto a los vendedores sobre sus cuentas.
...
**Configuración**: Crea una vista en ArjunaCRM con todos los destinatarios del boletín informativo.
...
**Problema**: Necesitas mantener los datos sincronizados entre ArjunaCRM y otro sistema en ambas direcciones.

**Solución**: Combina flujos de trabajo programados con disparadores de Webhooks para sincronización en tiempo real.

**Desde ArjunaCRM a Sistema Externo**:
...
**Desde Sistema Externo a ArjunaCRM**:
...
**Problema**: Los datos de fuentes externas necesitan un procesamiento complejo antes de poder ser utilizados en ArjunaCRM.
