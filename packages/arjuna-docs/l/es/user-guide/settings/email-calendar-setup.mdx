---
title: Configuración de correo y calendario
info: "Conecta tus cuentas de correo electrónico y calendario."
...
4. Autorizar a ArjunaCRM para acceder a tu Gmail y Calendario de Google
5. Tus correos y eventos del calendario comenzarán a sincronizarse automáticamente
...
4. Autorizar a ArjunaCRM para acceder a tu Outlook y Calendario de Microsoft
5. Tus correos y eventos del calendario comenzarán a sincronizarse automáticamente
...
<Warning>
Solo se pueden conectar verdaderos buzones (por ejemplo, soporte@dominio.com con su propia bandeja de entrada). Email aliases that forward to another mailbox cannot be connected to ArjunaCRM.
</Warning>
...
Controla qué carpetas de correo se sincronizan con ArjunaCRM:
...
**Nota**: No proporcionamos una dirección de correo CC para la sincronización selectiva. En su lugar, usa la función de carpeta de mensajes para lograr el mismo nivel de control sobre qué correos sincronizar con ArjunaCRM.
