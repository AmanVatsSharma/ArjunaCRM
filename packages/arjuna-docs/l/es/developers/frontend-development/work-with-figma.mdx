...
info: Aprende cómo puedes colaborar con ArjunaCRM en Figma
...
1. **Accede al enlace compartido:** Puedes acceder al archivo de Figma del proyecto [aquí](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/ArjunaCRM).
...
En la barra lateral izquierda, puedes acceder a las diferentes páginas del Figma de ArjunaCRM. Así es como están organizadas:
