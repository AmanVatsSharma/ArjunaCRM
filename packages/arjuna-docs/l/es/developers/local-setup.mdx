...
description: "La guía para los colaboradores (o desarrolladores curiosos) que quieren ejecutar ArjunaCRM localmente."
...
Antes de que puedas instalar y usar ArjunaCRM, asegúrate de instalar lo siguiente en tu computadora:
...
ArjunaCRM requiere un caché de redis para proporcionar el mejor rendimiento
...
Usa variables de entorno o archivos `.env` para configurar tu proyecto. Más información [aquí](https://docs.vedpragya.com/l/es/developers/self-hosting/setup)
...
Para compilar el servidor de ArjunaCRM e ingresar algunos datos en tu base de datos, ejecuta el siguiente comando:
...
## Paso 8: Use ArjunaCRM

**Frontend**

El frontend de ArjunaCRM estará ejecutándose en [http://localhost:3001](http://localhost:3001).
Puede iniciar sesión usando la cuenta demo por defecto: `tim@apple.dev` (contraseña: `tim@apple.dev`)

**Backend**

- El servidor de ArjunaCRM estará operativo en [http://localhost:3000](http://localhost:3000)
