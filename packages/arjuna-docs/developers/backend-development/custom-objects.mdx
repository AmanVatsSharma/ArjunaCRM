...
Standard objects are in-built objects with a set of attributes available for all users. Examples of standard objects in ArjunaCRM include Company and Person. Standard objects have standard fields that are also available for all ArjunaCRM users, like Company.displayName.
