...
1. In a terminal, on the host where ArjunaCRM is running, turn off ArjunaCRM: `docker compose down`
...
3. Bring ArjunaCRM back online with `docker compose up -d`
...
If you encounter any runtime issues after upgrading, you may need to flush your cache to ensure it's synchronized with the latest changes. Run this command in your arjuna-server container:
...
Upgrade your ArjunaCRM instance to use v0.55 image
...
Upgrade your ArjunaCRM instance to use v0.52 image
...
Upgrade your ArjunaCRM instance to use v0.51 image
...
Upgrade your ArjunaCRM instance to use v0.50.0 image
...
Please update your local `docker-compose.yml` with [v0.50.0 docker-compose.yml](https://github.com/vedpragyabharat/arjuna/blob/v0.50.0/packages/arjuna-docker/docker-compose.yml)

### v0.43.0 to v0.44.0

Upgrade your ArjunaCRM instance to use v0.44.0 image
...
Upgrade your ArjunaCRM instance to use v0.43.0 image
...
2. Upgrade your docker-compose.yml to use postgres:16 image as in the [docker-compose.yml](https://raw.githubusercontent.com/vedpragyabharat/arjuna/main/packages/arjuna-docker/docker-compose.yml) file.
...
Upgrade your ArjunaCRM instance to use v0.42.0 image
...
Upgrade your ArjunaCRM instance to use v0.41.0 image
...
Upgrade your ArjunaCRM instance to use v0.40.0 image
...
Upgrade your ArjunaCRM instance to use v0.35.0 image
...
Upgrade your ArjunaCRM instance to use v0.34.0 image
...
Upgrade your ArjunaCRM instance to use v0.33.0 image
...
Upgrade your ArjunaCRM instance to use v0.32.0 image
...
Upgrade your ArjunaCRM instance to use v0.31.0 image
...
Upgrade your ArjunaCRM instance to use v0.30.0 image

**Breaking change**:
To enhance performances, ArjunaCRM now requires redis cache to be configured. We have updated our [docker-compose.yml](https://raw.githubusercontent.com/vedpragyabharat/arjuna/main/packages/arjuna-docker/docker-compose.yml) to reflect this.
...
Upgrade your ArjunaCRM instance to use v0.24.0 image
...
Upgrade your ArjunaCRM instance to use v0.23.0 image
...
Upgrade your ArjunaCRM instance to use v0.22.0 image
