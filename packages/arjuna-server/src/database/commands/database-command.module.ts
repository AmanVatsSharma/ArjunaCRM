...
import { ComputeArjunaCRMStandardWorkspaceMigrationCommand } from 'src/database/commands/compute-arjuna-standard-workspace-migration.command';
...
@Module({
  ...
  providers: [
    ComputeArjunaCRMStandardWorkspaceMigrationCommand,
