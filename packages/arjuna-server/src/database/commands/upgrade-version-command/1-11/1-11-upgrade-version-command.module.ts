...
import { WorkspaceSchemaManagerModule } from 'src/engine/arjuna-orm/workspace-schema-manager/workspace-schema-manager.module';
...
@Module({
  ...
  providers: [
    ...
    CreateArjunaCRMStandardApplicationCommand,
  ],
  exports: [
    CleanOrphanedUserWorkspacesCommand,
    CleanOrphanedRoleTargetsCommand,
