...
import { CreateArjunaCRMStandardApplicationCommand } from 'src/database/commands/upgrade-version-command/1-11/1-11-create-arjuna-standard-application.command';
...
export class UpgradeCommand extends UpgradeCommandRunner {
  ...
  constructor(
    ...
    protected readonly arjunaConfigService: ArjunaCRMConfigService,
    ...
    protected readonly seedStandardApplicationsCommand: CreateArjunaCRMStandardApplicationCommand,

    // 1.12 Commands
    protected readonly setStandardApplicationNotUninstallableCommand: SetStandardApplicationNotUninstallableCommand,
    protected readonly createArjunaCRMStandardApplicationCommand: CreateArjunaCRMStandardApplicationCommand,
    ...
    const commands_1110: VersionCommands = {
      beforeSyncMetadata: [this.createArjunaCRMStandardApplicationCommand],
      afterSyncMetadata: [
