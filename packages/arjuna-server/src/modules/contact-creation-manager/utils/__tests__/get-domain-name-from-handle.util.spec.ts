import { type EachTestingContext } from 'arjuna-shared/testing';
...
describe('getDomainNameFromHandle', () => {
  const testCases: GetDomainNameFromHandleTestCase[] = [
    ...
    },
    {
      ...
      context: {
        input: 'user@test.app.arjuna.dev',
        expected: 'arjuna.dev',
      },
    },
    {
      ...
      context: {
        input: 'user@arjuna.co.uk',
        expected: 'arjuna.co.uk',
      },
    },
    {
