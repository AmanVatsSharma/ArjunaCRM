  ...
  return {
    post: {
      ...
      parameters: [
        {
          in: 'header',
          name: 'X-ArjunaCRM-Webhook-Signature',
          schema: {
            type: 'string',
          },
          description:
            'HMAC SHA256 signature of the request payload using the webhook secret. To compute the signature:\n' +
            '1. Concatenate `X-ArjunaCRM-Webhook-Timestamp`, a colon (:), and the JSON string of the request payload.\n' +
        ...
        {
          in: 'header',
          name: 'X-ArjunaCRM-Webhook-Timestamp',
          schema: {
            type: 'string',
          },
          description:
        ...
        {
          in: 'header',
          name: 'X-ArjunaCRM-Webhook-Nonce',
          schema: {
            type: 'string',
          },
          description:
