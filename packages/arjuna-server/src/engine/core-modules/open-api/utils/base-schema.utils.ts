...
\`\`\`text
Here is an OpenAPI schema for the ArjunaCRM REST API:\n${serverUrl}/rest/open-api/core?token=${token ?? '<your_token>'}
...
`,
      termsOfService:
        'https://github.com/vedpragyabharat/arjuna?tab=coc-ov-file#readme',
      contact: {
        email: 'felix@vedpragya.com',
      },
      license: {
        name: 'AGPL-3.0',
        url: 'https://github.com/vedpragyabharat/arjuna?tab=License-1-ov-file#readme',
      },
      version: API_Version,
    },
    // Testing purposes
    ...
    externalDocs: {
      description: 'Find out more about **ArjunaCRM**',
