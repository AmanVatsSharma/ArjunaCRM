...
@Module({
  imports: [
    ...
    MessageQueueModule.registerAsync({
      ...
      inject: [ArjunaCRMConfigService, RedisClientService],
    }),
    ExceptionHandlerModule.forRootAsync({
      useFactory: exceptionHandlerModuleFactory,
      inject: [ArjunaCRMConfigService, HttpAdapterHost],
    }),
    EmailModule.forRoot(),
    ...
    ServerlessModule.forRootAsync({
      ...
      inject: [ArjunaCRMConfigService, FileStorageService],
    }),
    SearchModule,
    ApiKeyModule,
    WebhookModule,
