...
export class GoogleAPIsOauthExchangeCodeForTokenGuard extends AuthGuard(
  ...
  async canActivate(context: ExecutionContext) {
    try {
      ...
      if (
        !this.arjunaConfigService.get('MESSAGING_PROVIDER_GMAIL_ENABLED') &&
        !this.arjunaConfigService.get('CALENDAR_PROVIDER_GOOGLE_ENABLED')
      ) {
      ...
      new GoogleAPIsOauthExchangeCodeForTokenStrategy(this.arjunaConfigService);
