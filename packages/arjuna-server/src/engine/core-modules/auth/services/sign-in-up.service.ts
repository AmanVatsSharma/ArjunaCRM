...
import { ARJUNA_ICONS_BASE_URL } from 'arjuna-shared/constants';
...
export class SignInUpService {
  ...
  private async saveNewUser(
    ...
    const serverUrl = this.arjunaConfigService.get('SERVER_URL');
  ...
  private isWorkspaceCreationLimitedToServerAdmins(): boolean {
    return this.arjunaConfigService.get(
  ...
  async signUpOnNewWorkspace(
    ...
    const logoUrl = `${ARJUNA_ICONS_BASE_URL}/${getDomainNameByEmail(email)}`;
