...
const ArjunaCRMConfigServiceGetAllMock = jest.fn();
const ArjunaCRMConfigServiceGetVariableWithMetadataMock = jest.fn();

jest.mock(
  'src/engine/core-modules/arjuna-config/constants/config-variables-group-metadata',
  () => ({
...
describe('AdminPanelService', () => {
        ...
        },
        {
          ...
          useValue: {
            getWorkspaceUrls: jest.fn().mockReturnValue({
              customUrl: undefined,
              subdomainUrl: 'https://arjuna.vedpragya.com',
            }),
          },
        },
        {
          ...
          useValue: {
            getAll: ArjunaCRMConfigServiceGetAllMock,
            getVariableWithMetadata:
              ArjunaCRMConfigServiceGetVariableWithMetadataMock,
          },
        },
        {
  ...
  describe('getConfigVariablesGrouped', () => {
    it('should correctly group and sort config variables', () => {
      ArjunaCRMConfigServiceGetAllMock.mockReturnValue({
        SERVER_URL: {
  ...
  describe('getVersionInfo', () => {
    ...
    beforeEach(() => {
      ...
      service['arjunaConfigService'].get = mockEnvironmentGet;
    });
  ...
  describe('getConfigVariable', () => {
    it('should return config variable with all fields', () => {
      ArjunaCRMConfigServiceGetVariableWithMetadataMock.mockReturnValue({
        value: 'test-value',
        metadata: {
          group: 'SERVER_CONFIG',
    ...
    it('should throw error when variable not found', () => {
      ArjunaCRMConfigServiceGetVariableWithMetadataMock.mockReturnValue(undefined);
