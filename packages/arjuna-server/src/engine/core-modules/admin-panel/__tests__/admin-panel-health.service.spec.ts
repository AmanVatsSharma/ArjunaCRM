...
describe('AdminPanelHealthService', () => {
  ...
  let arjunaConfigService: jest.Mocked<ArjunaCRMConfigService>;
  ...
  beforeEach(async () => {
    ...
    arjunaConfigService = { get: jest.fn() } as any;
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: ArjunaCRMConfigService, useValue: arjunaConfigService },
      ],
    }).compile();
