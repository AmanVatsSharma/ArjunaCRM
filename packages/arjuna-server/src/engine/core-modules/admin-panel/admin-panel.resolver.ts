...
import { ConfigVariableGraphqlApiExceptionFilter } from 'src/engine/core-modules/arjuna-config/filters/config-variable-graphql-api-exception.filter';
...
export class AdminPanelResolver {
  ...
  async getDatabaseConfigVariable(
    ...
    this.arjunaConfigService.validateConfigVariableExists(key as string);
  ...
  async createDatabaseConfigVariable(
    ...
    await this.arjunaConfigService.set(key, value);
  ...
  async updateDatabaseConfigVariable(
    ...
    await this.arjunaConfigService.update(key, value);
  ...
  async deleteDatabaseConfigVariable(
    ...
    await this.arjunaConfigService.delete(key);
