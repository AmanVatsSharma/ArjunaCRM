...
import { SendApprovedAccessDomainValidation } from 'arjuna-emails';
import { SettingsPath } from 'arjuna-shared/types';
import { getSettingsPath, isDefined } from 'arjuna-shared/utils';
    ...
    return crypto
      ...
      .update(
        JSON.stringify({
          ...
          domain: approvedAccessDomain.domain,
          key: this.arjunaConfigService.get('APP_SECRET'),
        }),
      )
      .digest('hex');
  }
