...
import { AwsRegion } from 'src/engine/core-modules/arjuna-config/interfaces/aws-region.interface';
...
import { CastToLogLevelArray } from 'src/engine/core-modules/arjuna-config/decorators/cast-to-log-level-array.decorator';
import { CastToMeterDriverArray } from 'src/engine/core-modules/arjuna-config/decorators/cast-to-meter-driver.decorator';
import { CastToPositiveNumber } from 'src/engine/core-modules/arjuna-config/decorators/cast-to-positive-number.decorator';
import { CastToUpperSnakeCase } from 'src/engine/core-modules/arjuna-config/decorators/cast-to-upper-snake-case.decorator';
import { ConfigVariablesMetadata } from 'src/engine/core-modules/arjuna-config/decorators/config-variables-metadata.decorator';
import { IsAWSRegion } from 'src/engine/core-modules/arjuna-config/decorators/is-aws-region.decorator';
import { IsDuration } from 'src/engine/core-modules/arjuna-config/decorators/is-duration.decorator';
import { IsOptionalOrEmptyString } from 'src/engine/core-modules/arjuna-config/decorators/is-optional-or-empty-string.decorator';
import { IsStrictlyLowerThan } from 'src/engine/core-modules/arjuna-config/decorators/is-strictly-lower-than.decorator';
import { IsArjunaCRMSemVer } from 'src/engine/core-modules/arjuna-config/decorators/is-arjuna-semver.decorator';
import { ConfigVariableType } from 'src/engine/core-modules/arjuna-config/enums/config-variable-type.enum';
import { ConfigVariablesGroup } from 'src/engine/core-modules/arjuna-config/enums/config-variables-group.enum';
import {
  ConfigVariableException,
  ConfigVariableExceptionCode,
} from 'src/engine/core-modules/arjuna-config/arjuna-config.exception';
...
export class ConfigVariables {
  ...
  EMAIL_FROM_NAME = 'Felix from ArjunaCRM';
  ...
  @ConfigVariablesMetadata({
    group: ConfigVariablesGroup.SERVER_CONFIG,
    description: 'ArjunaCRM server version',
    type: ConfigVariableType.STRING,
    isEnvOnly: true,
  })
