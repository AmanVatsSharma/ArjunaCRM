...
import { assertIsDefinedOrThrow, isDefined } from 'arjuna-shared/utils';
...
export class WorkspaceResolver {
  ...
  hasValidEnterpriseKey(): boolean {
    return isDefined(this.arjunaConfigService.get('ENTERPRISE_KEY'));
  }
  ...
  isGoogleAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.arjunaConfigService.get('AUTH_GOOGLE_ENABLED')
    );
  }
  ...
  isMicrosoftAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.arjunaConfigService.get('AUTH_MICROSOFT_ENABLED')
    );
  }
  ...
  isPasswordAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.arjunaConfigService.get('AUTH_PASSWORD_ENABLED')
    );
  }
