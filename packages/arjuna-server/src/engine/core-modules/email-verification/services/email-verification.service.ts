...
import ms from 'ms';
import { SendEmailVerificationLinkEmail } from 'arjuna-emails';
...
export class EmailVerificationService {
  ...
  async sendVerificationEmail({
    ...
    if (!this.arjunaConfigService.get('IS_EMAIL_VERIFICATION_REQUIRED')) {
    ...
    const emailVerificationMsg =
      verificationTrigger === EmailVerificationTrigger.EMAIL_UPDATE
        ...
        : msg`Welcome to ArjunaCRM: Please Confirm Your Email`;
