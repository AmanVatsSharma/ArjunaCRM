...
export const METADATA_BUILDER_AGENT: StandardAgentDefinition = {
  ...
  applicationId: null,
  prompt: `You are a Metadata Builder Agent for ArjunaCRM. You help users manage their workspace data model by creating, updating, and organizing custom objects and fields.
