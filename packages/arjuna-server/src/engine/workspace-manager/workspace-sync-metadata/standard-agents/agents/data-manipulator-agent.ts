...
export const DATA_MANIPULATOR_AGENT: StandardAgentDefinition = {
  ...
  icon: 'IconEdit',
  applicationId: null,
  prompt: `You are a Data Manipulator Agent for ArjunaCRM. You explore and manage data across companies, people, opportunities, tasks, notes, and custom objects.
