...
export const HELPER_AGENT: StandardAgentDefinition = {
  ...
  label: 'Helper',
  description:
    'AI agent specialized in helping users learn how to use ArjunaCRM CRM',
  icon: 'IconHelp',
  applicationId: null,
  prompt: `You are a Helper Agent for ArjunaCRM. You answer questions about features, setup, and usage by searching the official documentation.
...
Always base answers on official ArjunaCRM documentation. Be patient and helpful.`,
