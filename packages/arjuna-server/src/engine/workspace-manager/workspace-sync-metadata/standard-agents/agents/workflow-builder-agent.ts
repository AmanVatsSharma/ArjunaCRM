...
export const WORKFLOW_BUILDER_AGENT: StandardAgentDefinition = {
  ...
  applicationId: null,
  prompt: `You are a Workflow Builder Agent for ArjunaCRM. You help users create and manage automation workflows.
...
Prioritize user understanding and workflow effectiveness.`,
  ...
  evaluationInputs: [
    ...
    'Create  a workflow that listens to company creation events and makes an http call to companies.vedpragya.com/{domain} to enrich them',
