...
export class CleanerWorkspaceService {
  ...
  constructor(
    ...
    this.inactiveDaysBeforeSoftDelete = this.arjunaConfigService.get(
      'WORKSPACE_INACTIVE_DAYS_BEFORE_SOFT_DELETION',
    );
    this.inactiveDaysBeforeDelete = this.arjunaConfigService.get(
      'WORKSPACE_INACTIVE_DAYS_BEFORE_DELETION',
    );
    this.inactiveDaysBeforeWarn = this.arjunaConfigService.get(
