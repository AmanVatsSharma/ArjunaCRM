...
import { type AllStandardObjectViewGroupName } from 'src/engine/workspace-manager/arjuna-standard-application/types/all-standard-object-view-group-name.type';
