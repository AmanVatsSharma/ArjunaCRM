import { type ViewFilterOperand } from 'arjuna-shared/types';
import { isDefined } from 'arjuna-shared/utils';
import { v4 } from 'uuid';

import { type FlatViewFilter } from 'src/engine/metadata-modules/flat-view-filter/types/flat-view-filter.type';
import { STANDARD_OBJECTS } from 'src/engine/workspace-manager/arjuna-standard-application/constants/standard-object.constant';
...
import { type AllStandardObjectViewFilterName } from 'src/engine/workspace-manager/arjuna-standard-application/types/all-standard-object-view-filter-name.type';
import { type AllStandardObjectViewName } from 'src/engine/workspace-manager/arjuna-standard-application/types/all-standard-object-view-name.type';
import { type StandardBuilderArgs } from 'src/engine/workspace-manager/arjuna-standard-application/types/metadata-standard-buillder-args.type';
...
>({
  ...
  return {
    ...
    applicationId: arjunaStandardApplicationId,
    workspaceId,
    viewId:
