...
import { ArjunaCRMORMException } from 'src/engine/arjuna-orm/exceptions/arjuna-orm.exception';
import { arjunaORMGraphqlApiExceptionHandler } from 'src/engine/arjuna-orm/utils/arjuna-orm-graphql-api-exception-handler.util';
...
export const workspaceQueryRunnerGraphqlApiExceptionHandler = (
  ...
  switch (true) {
    ...
    case error instanceof ArjunaCRMORMException:
      return arjunaORMGraphqlApiExceptionHandler(error);
