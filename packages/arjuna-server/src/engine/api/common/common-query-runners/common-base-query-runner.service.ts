...
> {
  ...
  private async throttleQueryExecution(authContext: WorkspaceAuthContext) {
    try {
      ...
      const shortConfig = {
        ...
        maxTokens: this.arjunaConfigService.get(
          'API_RATE_LIMITING_SHORT_LIMIT',
        ),
        timeWindow: this.arjunaConfigService.get(
      ...
      const longConfig = {
        ...
        maxTokens: this.arjunaConfigService.get('API_RATE_LIMITING_LONG_LIMIT'),
        timeWindow: this.arjunaConfigService.get(
  ...
  private validateQueryComplexity(
    ...
    const maximumComplexity = this.arjunaConfigService.get(
