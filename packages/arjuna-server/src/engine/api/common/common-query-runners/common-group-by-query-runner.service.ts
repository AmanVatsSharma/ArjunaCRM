...
import { formatColumnNameForRelationField } from 'src/engine/arjuna-orm/utils/format-column-name-for-relation-field.util';
  ...
  private async addFiltersFromView({
    ...
    const recordFilterGroups = viewFilterGroups.map((viewFilterGroup) => {
      return {
        ...
        logicalOperator:
          viewFilterGroup.logicalOperator as unknown as RecordFilterGroupLogicalOperator, // TODO - https://github.com/vedpragyabharat/arjuna/issues/14746
