...
import { QUERY_MAX_RECORDS } from 'arjuna-shared/constants';
import { ObjectRecord } from 'arjuna-shared/types';
...
import { RolePermissionConfig } from 'src/engine/arjuna-orm/types/role-permission-config';
