...
import { type WorkspaceDataSourceInterface } from 'src/engine/arjuna-orm/interfaces/workspace-datasource.interface';
...
import { type WorkspaceDataSource } from 'src/engine/arjuna-orm/datasource/workspace.datasource';
import { type DeepPartialWithNestedRelationFields } from 'src/engine/arjuna-orm/entity-manager/types/deep-partial-entity-with-nested-relation-fields.type';
...
import { getEntityTarget } from 'src/engine/arjuna-orm/entity-manager/utils/get-entity-target';
import { computeArjunaCRMORMException } from 'src/engine/arjuna-orm/error-handling/compute-arjuna-orm-exception';
import { type GlobalWorkspaceDataSource } from 'src/engine/arjuna-orm/global-workspace-datasource/global-workspace-datasource';
import { RelationNestedQueries } from 'src/engine/arjuna-orm/relation-nested-queries/relation-nested-queries';
import {
  type OperationType,
  validateOperationIsPermittedOrThrow,
} from 'src/engine/arjuna-orm/repository/permissions.utils';
import { WorkspaceSelectQueryBuilder } from 'src/engine/arjuna-orm/repository/workspace-select-query-builder';
import { WorkspaceRepository } from 'src/engine/arjuna-orm/repository/workspace.repository';
import { getWorkspaceContext } from 'src/engine/arjuna-orm/storage/orm-workspace-context.storage';
import { type RolePermissionConfig } from 'src/engine/arjuna-orm/types/role-permission-config';
import { computePermissionIntersection } from 'src/engine/arjuna-orm/utils/compute-permission-intersection.util';
...
export class WorkspaceEntityManager extends EntityManager {
  ...
  >(
    ...
    try {
      ...
      throw computeArjunaCRMORMException(error, objectMetadataItem);
    }
  }
