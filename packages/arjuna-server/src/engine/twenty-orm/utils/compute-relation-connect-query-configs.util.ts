...
import { getUniqueConstraintsFields, isDefined } from 'arjuna-shared/utils';
...
import { type ConnectObject } from 'src/engine/arjuna-orm/entity-manager/types/query-deep-partial-entity-with-nested-relation-fields.type';
import {
  type RelationConnectQueryConfig,
  type UniqueConstraintCondition,
} from 'src/engine/arjuna-orm/entity-manager/types/relation-connect-query-config.type';
import { type RelationConnectQueryFieldsByEntityIndex } from 'src/engine/arjuna-orm/entity-manager/types/relation-nested-query-fields-by-entity-index.type';
import {
  ArjunaCRMORMException,
  ArjunaCRMORMExceptionCode,
} from 'src/engine/arjuna-orm/exceptions/arjuna-orm.exception';
import { formatCompositeField } from 'src/engine/arjuna-orm/utils/format-data.util';
...
const computeRecordToConnectCondition = (
  ...
  if (
    ...
    throw new ArjunaCRMORMException(
      ...
      ArjunaCRMORMExceptionCode.CONNECT_NOT_ALLOWED,
      {
...
const checkUniqueConstraintFullyPopulated = (
  ...
  if (!hasUniqueConstraintFieldFullyPopulated) {
    throw new ArjunaCRMORMException(
      ...
      ArjunaCRMORMExceptionCode.CONNECT_UNIQUE_CONSTRAINT_ERROR,
      {
