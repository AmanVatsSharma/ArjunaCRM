import { type PerformArjunaCRMConfigQueryParams } from 'test/integration/arjuna-config/types/perform-arjuna-config-query.type';
...
export const updateConfigVariable = async ({
  input,
  expectToFail = false,
}: PerformArjunaCRMConfigQueryParams<UpdateConfigVariableFactoryInput>) => {
