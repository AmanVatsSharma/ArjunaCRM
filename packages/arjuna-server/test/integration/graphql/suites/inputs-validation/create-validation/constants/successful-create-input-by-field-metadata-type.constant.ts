  ...
  [FieldMetadataType.LINKS]: [
    {
      input: {
        linksField: {
          ...
          secondaryLinks: [{ url: 'vedpragya.com', label: '#1 Open source CRM' }],
        },
      },
      validateInput: (record: Record<string, any>) => {
        return (
          record.linksField.primaryLinkUrl === 'https://vedpragya.com' &&
          record.linksField.primaryLinkLabel === '#1 Open source CRM' &&
          record.linksField.secondaryLinks.length === 1 &&
          record.linksField.secondaryLinks[0].url === 'vedpragya.com' &&
