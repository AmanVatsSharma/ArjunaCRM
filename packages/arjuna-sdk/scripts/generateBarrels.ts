...
const PACKAGE_PATH = path.resolve('packages/arjuna-sdk');
...
const main = () => {
  ...
  // Ensure top-level src/index.ts re-exports the root directories barrel so consumers can `import * from "arjuna-sdk"`
