...
export class AppCommand {
  ...
  getCommand(): Command {
    ...
    appCommand
      ...
      .description('Sync application to ArjunaCRM')
    ...
    appCommand
      ...
      .description('Uninstall application from ArjunaCRM')
      .action(async (appPath?: string) => {
        try {
    ...
    appCommand
      ...
      .description('Delete application from ArjunaCRM')
      .action(async (appPath?: string) => {
        try {
          const result = await this.uninstallCommand.execute({
            appPath: formatPath(appPath),
    ...
    appCommand
      ...
      .description('Generate ArjunaCRM client')
      .action(async (appPath?: string) => {
