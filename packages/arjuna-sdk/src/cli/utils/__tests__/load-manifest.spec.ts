...
const arjunaSdkTypesMock = `
declare module 'arjuna-sdk' {
...
import { type FunctionConfig } from 'arjuna-sdk';
...
const packageJsonMock = {
  ...
  scripts: {
    'create-entity': 'arjuna app add',
    dev: 'arjuna app dev',
    generate: 'arjuna app generate',
    sync: 'arjuna app sync',
    uninstall: 'arjuna app uninstall',
    auth: 'arjuna auth login',
  },
  dependencies: {
    'arjuna-sdk': '0.1.0',
  },
...
const applicationConfigMock = `import { type ApplicationConfig } from 'arjuna-sdk';
...
describe('loadManifest (integration)', () => {
  ...
  beforeEach(async () => {
    ...
    write(
      appDirectory,
      'src/types/arjuna-sdk-application.d.ts',
      arjunaSdkTypesMock,
    );
