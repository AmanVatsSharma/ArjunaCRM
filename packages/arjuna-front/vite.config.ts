...
export default defineConfig(({ command, mode }) => {
  ...
  return {
    root: __dirname,
    cacheDir: '../../node_modules/.vite/packages/arjuna-front',
    ...
    resolve: {
      alias: {
        ...
        // https://github.com/vedpragyabharat/arjuna/pull/10782/files
        // This will likely be migrated to arjuna-ui package when built separately
