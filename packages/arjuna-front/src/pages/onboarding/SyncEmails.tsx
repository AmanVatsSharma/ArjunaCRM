...
import { AppPath, ConnectedAccountProvider } from 'arjuna-shared/types';
import { IconGoogle, IconMicrosoft } from 'arjuna-ui/display';
import { MainButton } from 'arjuna-ui/input';
import { ClickToActionLink } from 'arjuna-ui/navigation';
import {
...
export const SyncEmails = () => {
  ...
  return (
    <Modal.Content isVerticalCentered isHorizontalCentered>
      ...
      <SubTitle>
        Sync your Emails and Calendar with ArjunaCRM. Choose your privacy settings.
      </SubTitle>
