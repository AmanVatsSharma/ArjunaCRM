...
import { ComponentDecorator, RouterDecorator } from 'arjuna-ui/testing';
...
const CONFIGURED_ACTION: WorkflowSendEmailAction = {
  ...
  settings: {
    input: {
      ...
      email: 'test@vedpragya.com',
      subject: 'Welcome to ArjunaCRM!',
      body: 'Dear Tim,\n\nWelcome to ArjunaCRM! We are excited to have you on board.\n\nBest regards,\nThe Team',
      files: [],
    },
    outputSchema: {},
    errorHandlingOptions: {
...
export const Configured: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const emailInput = await canvas.findByText('tim@vedpragya.com');
    expect(emailInput).toBeVisible();

    const subjectInput = await canvas.findByText('Welcome to ArjunaCRM!');
