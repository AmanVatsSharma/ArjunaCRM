...
import {
  ...
  CurrencyCode,
} from 'arjuna-shared/constants';
import { ConnectedAccountProvider } from 'arjuna-shared/types';
import {
...
//TODO : isIncludedInUniqueConstraint refactor - https://github.com/vedpragyabharat/core-team-issues/issues/1097
...
export const SETTINGS_COMPOSITE_FIELD_TYPE_CONFIGS = {
  ...
  [FieldMetadataType.EMAILS]: {
    ...
    exampleValues: [
      {
        primaryEmail: 'tim@vedpragya.com',
        additionalEmails: [
          'tim@vedpragya.com',
          'timapple@vedpragya.com',
          'johnappletim@vedpragya.com',
        ],
      },
      {
        primaryEmail: 'jane@vedpragya.com',
        additionalEmails: ['jane@vedpragya.com', 'jane.doe@vedpragya.com'],
      },
      {
        primaryEmail: 'john@vedpragya.com',
        additionalEmails: ['john.doe@vedpragya.com'],
      },
    ],
    category: 'Basic',
  ...
  [FieldMetadataType.LINKS]: {
    ...
    exampleValues: [
      {
        primaryLinkUrl: 'vedpragya.com',
        primaryLinkLabel: '',
        secondaryLinks: [{ url: 'vedpragya.com', label: 'ArjunaCRM' }],
      },
      {
        primaryLinkUrl: 'github.com/vedpragyabharat/arjuna',
        primaryLinkLabel: 'ArjunaCRM Repo',
        secondaryLinks: [{ url: 'vedpragya.com', label: '' }],
      },
      {
