...
import { isDefined, isEmptyObject } from 'arjuna-shared/utils';
  ...
  return Object.entries(filter).every(([filterKey, filterValue]) => {
    ...
    switch (objectMetadataField.type) {
      ...
      case FieldMetadataType.RICH_TEXT: {
        ...
        // See this issue for more context: https://github.com/vedpragyabharat/arjuna/issues/7613#issuecomment-2408944585
