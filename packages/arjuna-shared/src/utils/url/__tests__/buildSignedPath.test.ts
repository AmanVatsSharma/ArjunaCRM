...
describe('buildSignedPath', () => {
  ...
  it('should ignore absolute https urls', () => {
    expect(
      buildSignedPath({
        path: 'https://vedpragyabharat.github.io/placeholder-images/workspaces/arjuna-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'https://vedpragyabharat.github.io/placeholder-images/workspaces/arjuna-logo.png',
    );
  });
  ...
  it('should ignore absolute http urls', () => {
    expect(
      buildSignedPath({
        path: 'http://vedpragyabharat.github.io/placeholder-images/workspaces/arjuna-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'http://vedpragyabharat.github.io/placeholder-images/workspaces/arjuna-logo.png',
    );
  });
});
