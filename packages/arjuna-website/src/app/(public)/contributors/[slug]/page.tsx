...
export async function generateMetadata(props: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    metadataBase: new URL(`https://vedpragya.com`),
    title: 'ArjunaCRM - ' + slug,
    description:
      'Explore the impactful contributions of ' +
      slug +
      ' on the ArjunaCRM Github Repo. Discover their merged pull requests, ongoing work, and top ranking. Join and contribute to the #1 Open-Source CRM thriving community!',
    openGraph: {
      images: [`https://vedpragya.com/api/contributors/${slug}/og.png`],
    },
  };
}
