...
import { ARJUNA_TEAM_MEMBERS } from '@/shared-utils/listTeamMembers';

export const metadata = {
  title: 'ArjunaCRM - Contributors',
  description:
    'Discover the brilliant minds behind ArjunaCRM.com. Meet our contributors and explore how their expertise contributes to making ArjunaCRM the leading open-source CRM. Join our community today.',
...
const Contributors = async () => {
  ...
  const fitlerContributors = contributors
    ...
    .filter((contributor) => !ARJUNA_TEAM_MEMBERS.includes(contributor.id))
    .map((contributor) => {
