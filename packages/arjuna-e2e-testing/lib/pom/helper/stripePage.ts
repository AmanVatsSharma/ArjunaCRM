...
export class StripePage {
  ...
  private readonly returnToArjunaCRMLink: Locator;
  ...
  constructor(public readonly page: Page) {
    ...
    this.returnToArjunaCRMLink = page.getByTestId('return-to-business-link');
  }
  ...
  async returnToArjunaCRM() {
    await this.returnToArjunaCRMLink.click();
  }
}
