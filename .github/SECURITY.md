...
- Contact the team at `security at vedpragya.com`.
- Include a comprehensive description of the potential vulnerability and steps to reproduce the issue, if possible. The more information you can provide, the quicker ArjunaCRM can address the problem.
...
While ArjunaCRM doesn't have a formal bug bounty program right now due to the project's nascent stage, rest assured that:
...
- Your contribution is greatly appreciated, and ArjunaCRM would acknowledge your role in the vulnerability fix, if you opt for identification.
- ArjunaCRM will grant you permission to publicly discuss your findings once users have had a reasonable time to apply the patch after it becomes available.
- ArjunaCRM guarantees not to pursue any legal action as long as the vulnerability is not exploited.
